...
[PR #8](https://github.com/rotemtam/fluent-versioned-migrations-demo/pull/8/files)
...
```sql title="fluent/migrate/migrations/20221116051710_user_title_required.sql"
-- modify "users" table
...
```shell
atlas migrate lint --dev-url mysql://root:pass@localhost:3306/dev --dir file://fluent/migrate/migrations --latest 1
```
...
- Subscribe to our [Newsletter](https://fluentgo.substack.com/)
- Follow us on [Twitter](https://twitter.com/fluentgo_io)
- Join us on #ent on the [Gophers Slack](https://github.com/usalko/fluent/docs/slack)
