...
The change described in this section can be found in PR [#2](https://github.com/rotemtam/fluent-versioned-migrations-demo/pull/2/files)
...
{label: 'Using the flc package', value: 'flc'},
]}>
<TabItem value="fluent">
...
//go:generate go run -mod=mod github.com/usalko/fluent/cmd/fluent generate --feature sql/versioned-migration ./schema
```

</TabItem>
<TabItem value="flc">

If you are using the code generation package (e.g. if you are using an Ent extension like ` fluent_gql`),
...
[methods added](https://github.com/rotemtam/fluent-versioned-migrations-demo/commit/e724fa32330d920fd405b9785fcfece2a46ea56c#diff-370235e5107bbdd35861063f3beff1507723ebdda6e29a39cdde1f1a944594d8)
...
The change described in this section can be found in PR [#4](https://github.com/rotemtam/fluent-versioned-migrations-demo/pull/4/files)
in the supporting repository.
...
```text
mkdir fluent/migrate/migrations
```

Then, run the script to create the initial migration file for your project:

```shell
go run -mod=mod fluent/migrate/main.go initial
```
...
To learn more about how to use these tools with Ent, see the [docs](https://github.com/usalko/fluent/docs/versioned-migrations#create-a-migration-files-generator) on this subject.