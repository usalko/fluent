...
[PR #5](https://github.com/rotemtam/fluent-versioned-migrations-demo/pull/5/files)
...
```text
atlas migrate apply --dir file://fluent/migrate/migrations --url mysql://root:pass@localhost:3306/db --baseline 20221114165732
```
...
```text
atlas migrate status --dir file://fluent/migrate/migrations --url mysql://root:pass@localhost:3306/db
```
Atlas reports:
```text
Migration Status: OK
