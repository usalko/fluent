...
Consider an fluent query such as: 
...
JSON predicates are not generated by default as part of the code generation. However, fluent provides an official package
