...
[ent/contrib/ci](https://github.com/usalko/contrib/tree/master/ci) a GitHub Action
...
<TabItem value="gh">
Simply add a file named `.github/workflows/fluent-ci.yaml` in your repository:
