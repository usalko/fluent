    ...
    const ProjectTitle = () => (
      <div>
        <div className="projectTitleContainer">
          <img src="https://github.com/usalko/fluent/images/assets/logo.png" />
      ...
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <div className="gopherGraph">
            <img src="https://github.com/usalko/fluent/images/assets/gopher_graph.png" />
          </div>
          <Features />
        </div>
      </SplashContainer>
...
class HomeNav extends React.Component {
    render() {
        return <ul className="home-nav">
            ...
            <li className="header-godoc-link"><a href="https://pkg.go.dev/github.com/usalko/fluent?tab=doc" target="_blank">GoDoc</a></li>
            <li className=""><a href="https://github.com/usalko/fluent" target="_blank">Github</a></li>
