...
const config = {
  ...
  "url": "https://github.com/usalko/fluent",
  "baseUrl": "/",
  ...
  "customFields": {
    ...
    "newsletter": "https://fluentgo.substack.com/",
    "githubRepo": "https://github.com/usalko/fluent"
  },
  "onBrokenLinks": "log",
  ...
  "presets": [
    [
      "@docusaurus/preset-classic",
      {
        "docs": {
          path: "../md",
          editUrl: 'https://github.com/usalko/fluent/edit/master/doc/md/',
  ...
  "themeConfig": {
    ...
    "navbar": {
      ...
      "items": [
        ...
        {
          "href": "https://pkg.go.dev/github.com/usalko/fluent?tab=doc",
          "label": "GoDoc",
          "position": "left",
        ...
        {
          href: 'https://fluentgo.substack.com/',
          position: 'right',
          className: 'header-newsletter-link',
          'aria-label': 'Newsletter page',
        },
        {
          href: 'https://twitter.com/fluentgo_io',
          position: 'right',
          className: 'header-twitter-link',
          'aria-label': 'Twitter page',
        },
        {
          href: 'https://github.com/usalko/fluent',
          position: 'right',
    ...
    "footer": {
      "links": [
        ...
        },
        {
          "title": "Community",
          "items": [
            {"label": "GitHub", "to": "https://github.com/usalko/fluent"},
            {"label": "Slack", "to": "/docs/community#slack"},
            {"label": "Discord", "to": "https://discord.gg/qZmPgTE6RX"},
            {"label": "Newsletter", "to": "https://fluentgo.substack.com/"},
            {"label": "Discussions", "to": "https://github.com/usalko/fluent/discussions"},
            {
              "label": "Twitter",
              "to": "https://twitter.com/fluentgo_io"
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "items": [
            {"html": `
            <a href="https://github.com/usalko/fluent/stargazers">
                <img src="https://img.shields.io/github/stars/fluent/fluent?style=social"/>
            </a>`},
            {"html": `
            <a href="https://twitter.com/fluentgo_io">
                <img src="https://img.shields.io/twitter/follow/fluentgo_io?style=social"/>
            </a>`}
          ]
        }
      ],
    ...
    announcementBar: {
      ...
      // content: `⭐️ If you like Ent, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/usalko/fluent">GitHub</a> and follow us on <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/fluentgo_io" >Twitter</a> ${TwitterSvg}`,
