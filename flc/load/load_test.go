...
func TestLoad(t *testing.T) {
	...
	require.Equal(t, "github.com/usalko/fluent/flc/load/testdata/valid", spec.PkgPath)
...
func TestLoadCycleError(t *testing.T) {
	...
	spec, err := cfg.Load()
	require.Nil(t, spec)
	require.EqualError(t, err, `flc/load: parse schema dir: import cycle not allowed: import stack: [github.com/usalko/fluent/flc/load/testdata/cycle github.com/usalko/fluent/flc/load/testdata/cycle/fakent github.com/usalko/fluent/flc/load/testdata/cycle]
