...
type Group struct{ fluent.Schema }

func (Group) Fields() []fluent.Field { return nil }
...
func TestMarshalSchema(t *testing.T) {
	for _, u := range []fluent.Interface{User{}, &User{}} {
...
func (InvalidEdge) Edges() []fluent.Edge {
	return []fluent.Edge{
...
func (InvalidUUID) Fields() []fluent.Field {
	return []fluent.Field{
...
func (WithDefaults) Fields() []fluent.Field {
	return []fluent.Field{
		field.Int("int").
			Default(1),
		field.Float("float").
...
func (WithDefaults) Edges() []fluent.Edge {
	return nil
}

func (WithDefaults) Indexes() []fluent.Index {
	return nil
}
...
func (HooksMixin) Fields() []fluent.Field {
	return []fluent.Field{
		field.String("boring"),
	}
}

func (HooksMixin) Edges() []fluent.Edge {
	return []fluent.Edge{
...
func (HooksMixin) Indexes() []fluent.Index {
	return []fluent.Index{
		index.Fields("boring").
			Edges("user"),
	}
...
func (HooksMixin) Hooks() []fluent.Hook {
	return []fluent.Hook{
		func(fluent.Mutator) fluent.Mutator { return nil },
		func(fluent.Mutator) fluent.Mutator { return nil },
	}
}
...
func (BoringPolicy) EvalMutation(context.Context, fluent.Mutation) error { return nil }
func (BoringPolicy) EvalQuery(context.Context, fluent.Query) error       { return nil }

type PrivacyMixin struct {
	mixin.Schema
}

func (PrivacyMixin) Policy() fluent.Policy {
	return BoringPolicy{}
}
...
func (WithMixin) Mixin() []fluent.Mixin {
	return []fluent.Mixin{
		TimeMixin{},
		HooksMixin{},
		PrivacyMixin{},
...
func (WithMixin) Fields() []fluent.Field {
	return []fluent.Field{
		field.Int("field"),
	}
}

func (WithMixin) Edges() []fluent.Edge {
	return []fluent.Edge{
		edge.To("owner", User.Type),
	}
}

func (WithMixin) Indexes() []fluent.Index {
	return []fluent.Index{
		index.Fields("field").
			Edges("owner").
			Unique(),
...
func (WithMixin) Hooks() []fluent.Hook {
	return []fluent.Hook{
		func(fluent.Mutator) fluent.Mutator { return nil },
	}
}

func (WithMixin) Policy() fluent.Policy {
	return BoringPolicy{}
}
