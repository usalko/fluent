...
func (afu *AttachedFileUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(attached_file.Table, attached_file.Columns, sqlgraph.NewFieldSpec(attached_file.FieldID, field.TypeInt))
