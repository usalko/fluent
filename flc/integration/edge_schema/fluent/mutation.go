...
var _ fluent.Mutation = (*AttachedFileMutation)(nil)
...
func (m *AttachedFileMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AttachedFileMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
func (m *AttachedFileMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
func (m *FileMutation) AddedIDs(name string) []fluent.Value {
	...
	case file.EdgeProcesses:
		ids := make([]fluent.Value, 0, len(m.processes))
		for id := range m.processes {
			ids = append(ids, id)
		}
		return ids
...
func (m *FileMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case file.EdgeProcesses:
		ids := make([]fluent.Value, 0, len(m.removedprocesses))
		for id := range m.removedprocesses {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*FriendshipMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *FriendshipMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *FriendshipMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case friendship.FieldWeight:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FriendshipMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case friendship.FieldWeight:
		v, ok := value.(int)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *FriendshipMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	case friendship.FieldWeight:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *FriendshipMutation) AddField(name string, value fluent.Value) error {
	switch name {
	case friendship.FieldWeight:
		v, ok := value.(int)
		if !ok {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *FriendshipMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *FriendshipMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
func (m *GroupMutation) AddedIDs(name string) []fluent.Value {
	...
	case group.EdgeUsers:
		...
		return ids
	case group.EdgeTags:
		ids := make([]fluent.Value, 0, len(m.tags))
		for id := range m.tags {
			ids = append(ids, id)
		}
		return ids
	case group.EdgeJoinedUsers:
		ids := make([]fluent.Value, 0, len(m.joined_users))
		for id := range m.joined_users {
			ids = append(ids, id)
		}
		return ids
	case group.EdgeGroupTags:
		ids := make([]fluent.Value, 0, len(m.group_tags))
		for id := range m.group_tags {
			ids = append(ids, id)
		}
		return ids
...
func (m *GroupMutation) RemovedIDs(name string) []fluent.Value {
	...
	case group.EdgeUsers:
		...
		return ids
	case group.EdgeTags:
		ids := make([]fluent.Value, 0, len(m.removedtags))
		for id := range m.removedtags {
			ids = append(ids, id)
		}
		return ids
	case group.EdgeJoinedUsers:
		ids := make([]fluent.Value, 0, len(m.removedjoined_users))
		for id := range m.removedjoined_users {
			ids = append(ids, id)
		}
		return ids
	case group.EdgeGroupTags:
		ids := make([]fluent.Value, 0, len(m.removedgroup_tags))
		for id := range m.removedgroup_tags {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*GroupTagMutation)(nil)
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *GroupTagMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *GroupTagMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *GroupTagMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*ProcessMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ProcessMutation) Field(name string) (fluent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ProcessMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ProcessMutation) SetField(name string, value fluent.Value) error {
	switch name {
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ProcessMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ProcessMutation) AddField(name string, value fluent.Value) error {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ProcessMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	...
	case process.EdgeAttachedFiles:
		ids := make([]fluent.Value, 0, len(m.attached_files))
		for id := range m.attached_files {
			ids = append(ids, id)
		}
		return ids
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ProcessMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case process.EdgeFiles:
		...
		return ids
	case process.EdgeAttachedFiles:
		ids := make([]fluent.Value, 0, len(m.removedattached_files))
		for id := range m.removedattached_files {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*RelationshipMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *RelationshipMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *RelationshipMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RelationshipMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case relationship.FieldWeight:
		v, ok := value.(int)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *RelationshipMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	case relationship.FieldWeight:
		return m.AddedWeight()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RelationshipMutation) AddField(name string, value fluent.Value) error {
	switch name {
	case relationship.FieldWeight:
		v, ok := value.(int)
		if !ok {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *RelationshipMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *RelationshipMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*RelationshipInfoMutation)(nil)
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *RelationshipInfoMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RelationshipInfoMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *RelationshipInfoMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *RelationshipInfoMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*RoleMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *RoleMutation) Field(name string) (fluent.Value, bool) {
	switch name {
	case role.FieldName:
		return m.Name()
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *RoleMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case role.FieldName:
		return m.OldName(ctx)
	case role.FieldCreatedAt:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RoleMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case role.FieldName:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *RoleMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RoleMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *RoleMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case role.EdgeUser:
		ids := make([]fluent.Value, 0, len(m.user))
		for id := range m.user {
			ids = append(ids, id)
		}
		return ids
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *RoleMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case role.EdgeUser:
		ids := make([]fluent.Value, 0, len(m.removeduser))
		for id := range m.removeduser {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*RoleUserMutation)(nil)
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *RoleUserMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *RoleUserMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RoleUserMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *RoleUserMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*TagMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *TagMutation) Field(name string) (fluent.Value, bool) {
	switch name {
	case tag.FieldValue:
		return m.Value()
	}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *TagMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case tag.FieldValue:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TagMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case tag.FieldValue:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *TagMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TagMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *TagMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case tag.EdgeTweets:
		ids := make([]fluent.Value, 0, len(m.tweets))
		for id := range m.tweets {
			ids = append(ids, id)
		}
		return ids
	...
	case tag.EdgeTweetTags:
		ids := make([]fluent.Value, 0, len(m.tweet_tags))
		for id := range m.tweet_tags {
			ids = append(ids, id)
		}
		return ids
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TagMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case tag.EdgeTweets:
		ids := make([]fluent.Value, 0, len(m.removedtweets))
		for id := range m.removedtweets {
			ids = append(ids, id)
		}
		return ids
	case tag.EdgeGroups:
		...
		return ids
	case tag.EdgeTweetTags:
		ids := make([]fluent.Value, 0, len(m.removedtweet_tags))
		for id := range m.removedtweet_tags {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*TweetMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *TweetMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *TweetMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case tweet.FieldText:
		return m.OldText(ctx)
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TweetMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case tweet.FieldText:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *TweetMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TweetMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *TweetMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case tweet.EdgeLikedUsers:
		ids := make([]fluent.Value, 0, len(m.liked_users))
		for id := range m.liked_users {
			ids = append(ids, id)
		}
		return ids
	...
	case tweet.EdgeTweetUser:
		ids := make([]fluent.Value, 0, len(m.tweet_user))
		for id := range m.tweet_user {
			ids = append(ids, id)
		}
		return ids
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TweetMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case tweet.EdgeLikedUsers:
		ids := make([]fluent.Value, 0, len(m.removedliked_users))
		for id := range m.removedliked_users {
			ids = append(ids, id)
		}
		return ids
	...
	case tweet.EdgeTags:
		...
		return ids
	case tweet.EdgeTweetUser:
		ids := make([]fluent.Value, 0, len(m.removedtweet_user))
		for id := range m.removedtweet_user {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*TweetLikeMutation)(nil)
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *TweetLikeMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *TweetLikeMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TweetLikeMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TweetLikeMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*TweetTagMutation)(nil)
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *TweetTagMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TweetTagMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TweetTagMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
func (m *UserMutation) AddedIDs(name string) []fluent.Value {
	...
	case user.EdgeRelatives:
		ids := make([]fluent.Value, 0, len(m.relatives))
		for id := range m.relatives {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeLikedTweets:
		ids := make([]fluent.Value, 0, len(m.liked_tweets))
		for id := range m.liked_tweets {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeTweets:
		...
		return ids
	case user.EdgeRoles:
		ids := make([]fluent.Value, 0, len(m.roles))
		for id := range m.roles {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeJoinedGroups:
		ids := make([]fluent.Value, 0, len(m.joined_groups))
		for id := range m.joined_groups {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeFriendships:
		ids := make([]fluent.Value, 0, len(m.friendships))
		for id := range m.friendships {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeUserTweets:
		ids := make([]fluent.Value, 0, len(m.user_tweets))
		for id := range m.user_tweets {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []fluent.Value {
	...
	case user.EdgeFriends:
		...
		return ids
	case user.EdgeRelatives:
		ids := make([]fluent.Value, 0, len(m.removedrelatives))
		for id := range m.removedrelatives {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeLikedTweets:
		ids := make([]fluent.Value, 0, len(m.removedliked_tweets))
		for id := range m.removedliked_tweets {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeTweets:
		...
		return ids
	case user.EdgeRoles:
		ids := make([]fluent.Value, 0, len(m.removedroles))
		for id := range m.removedroles {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeJoinedGroups:
		ids := make([]fluent.Value, 0, len(m.removedjoined_groups))
		for id := range m.removedjoined_groups {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeFriendships:
		ids := make([]fluent.Value, 0, len(m.removedfriendships))
		for id := range m.removedfriendships {
			ids = append(ids, id)
		}
		return ids
	case user.EdgeUserTweets:
		ids := make([]fluent.Value, 0, len(m.removeduser_tweets))
		for id := range m.removeduser_tweets {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*UserGroupMutation)(nil)
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *UserGroupMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserGroupMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UserGroupMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*UserTweetMutation)(nil)
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *UserTweetMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserTweetMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UserTweetMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
