...
func (*RelationshipInfo) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case relationship_info.FieldID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the RelationshipInfo.
// This includes values selected through modifiers, order, etc.
func (ri *RelationshipInfo) Value(name string) (fluent.Value, error) {
...
func (ri *RelationshipInfo) Unwrap() *RelationshipInfo {
	...
	if !ok {
		panic("fluent: RelationshipInfo is not a transactional entity")
	}
