...
func (*UserTweet) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user_tweet.FieldID, user_tweet.FieldUserID, user_tweet.FieldTweetID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the UserTweet.
// This includes values selected through modifiers, order, etc.
func (ut *UserTweet) Value(name string) (fluent.Value, error) {
