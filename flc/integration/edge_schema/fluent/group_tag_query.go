...
func (gtq *GroupTagQuery) Order(o ...group_tag.OrderOption) *GroupTagQuery {
...
func (gtq *GroupTagQuery) QueryTag() *TagQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(group_tag.Table, group_tag.FieldID, selector),
...
func (gtq *GroupTagQuery) First(ctx context.Context) (*GroupTag, error) {
	nodes, err := gtq.Limit(1).All(setContextOp(ctx, gtq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{group_tag.Label}
	}
	return nodes[0], nil
}
...
func (gtq *GroupTagQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = gtq.Limit(1).IDs(setContextOp(ctx, gtq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{group_tag.Label}
		return
	}
	return ids[0], nil
}
...
func (gtq *GroupTagQuery) Only(ctx context.Context) (*GroupTag, error) {
	nodes, err := gtq.Limit(2).All(setContextOp(ctx, gtq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{group_tag.Label}
	default:
		return nil, &NotSingularError{group_tag.Label}
	}
}
...
func (gtq *GroupTagQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = gtq.Limit(2).IDs(setContextOp(ctx, gtq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{group_tag.Label}
	default:
		err = &NotSingularError{group_tag.Label}
	}
	return
}
...
func (gtq *GroupTagQuery) All(ctx context.Context) ([]*GroupTag, error) {
	ctx = setContextOp(ctx, gtq.ctx, fluent.OpQueryAll)
	if err := gtq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (gtq *GroupTagQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, gtq.ctx, fluent.OpQueryIDs)
	if err = gtq.Select(group_tag.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (gtq *GroupTagQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, gtq.ctx, fluent.OpQueryCount)
	if err := gtq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (gtq *GroupTagQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, gtq.ctx, fluent.OpQueryExist)
...
func (gtq *GroupTagQuery) Clone() *GroupTagQuery {
	...
	return &GroupTagQuery{
		config:     gtq.config,
		ctx:        gtq.ctx.Clone(),
		order:      append([]group_tag.OrderOption{}, gtq.order...),
...
func (gtq *GroupTagQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(group_tag.Table, group_tag.Columns, sqlgraph.NewFieldSpec(group_tag.FieldID, field.TypeInt))
	_spec.From = gtq.sql
	...
	if fields := gtq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, group_tag.FieldID)
		for i := range fields {
			if fields[i] != group_tag.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if gtq.withTag != nil {
			_spec.Node.AddColumnOnce(group_tag.FieldTagID)
		}
		if gtq.withGroup != nil {
			_spec.Node.AddColumnOnce(group_tag.FieldGroupID)
		}
	}
...
func (gtq *GroupTagQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(group_tag.Table)
...
func (gtgb *GroupTagGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, gtgb.build.ctx, fluent.OpQueryGroupBy)
...
func (gts *GroupTagSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, gts.ctx, fluent.OpQuerySelect)
