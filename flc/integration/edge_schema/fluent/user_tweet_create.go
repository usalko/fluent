...
func (utc *UserTweetCreate) createSpec() (*UserTweet, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(user_tweet.Table, sqlgraph.NewFieldSpec(user_tweet.FieldID, field.TypeInt))
	)
...
//		// update values.
//		Update(func(u *fluent.UserTweetUpsert) {
//			SetCreatedAt(v+v).
//		}).
//		Exec(ctx)
...
func (u *UserTweetUpsert) UpdateTweetID() *UserTweetUpsert {
	u.SetExcluded(user_tweet.FieldTweetID)
	return u
}
