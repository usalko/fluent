...
func (*UserGroup) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user_group.FieldID, user_group.FieldUserID, user_group.FieldGroupID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the UserGroup.
// This includes values selected through modifiers, order, etc.
func (ug *UserGroup) Value(name string) (fluent.Value, error) {
