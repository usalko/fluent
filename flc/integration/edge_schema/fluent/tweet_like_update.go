...
func (tlu *TweetLikeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(tweet_like.Table, tweet_like.Columns, sqlgraph.NewFieldSpec(tweet_like.FieldUserID, field.TypeInt), sqlgraph.NewFieldSpec(tweet_like.FieldTweetID, field.TypeInt))
	...
	if n, err = sqlgraph.UpdateNodes(ctx, tlu.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{tweet_like.Label}
