...
func (ttq *TweetTagQuery) Order(o ...tweet_tag.OrderOption) *TweetTagQuery {
...
func (ttq *TweetTagQuery) QueryTag() *TagQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(tweet_tag.Table, tweet_tag.FieldID, selector),
...
func (ttq *TweetTagQuery) First(ctx context.Context) (*TweetTag, error) {
	nodes, err := ttq.Limit(1).All(setContextOp(ctx, ttq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{tweet_tag.Label}
	}
	return nodes[0], nil
}
...
func (ttq *TweetTagQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
	if ids, err = ttq.Limit(1).IDs(setContextOp(ctx, ttq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{tweet_tag.Label}
		return
	}
	return ids[0], nil
}
...
func (ttq *TweetTagQuery) Only(ctx context.Context) (*TweetTag, error) {
	nodes, err := ttq.Limit(2).All(setContextOp(ctx, ttq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{tweet_tag.Label}
	default:
		return nil, &NotSingularError{tweet_tag.Label}
	}
}
...
func (ttq *TweetTagQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
	if ids, err = ttq.Limit(2).IDs(setContextOp(ctx, ttq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{tweet_tag.Label}
	default:
		err = &NotSingularError{tweet_tag.Label}
	}
	return
}
...
func (ttq *TweetTagQuery) All(ctx context.Context) ([]*TweetTag, error) {
	ctx = setContextOp(ctx, ttq.ctx, fluent.OpQueryAll)
	if err := ttq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (ttq *TweetTagQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	ctx = setContextOp(ctx, ttq.ctx, fluent.OpQueryIDs)
	if err = ttq.Select(tweet_tag.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (ttq *TweetTagQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, ttq.ctx, fluent.OpQueryCount)
	if err := ttq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (ttq *TweetTagQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, ttq.ctx, fluent.OpQueryExist)
...
func (ttq *TweetTagQuery) Clone() *TweetTagQuery {
	...
	return &TweetTagQuery{
		config:     ttq.config,
		ctx:        ttq.ctx.Clone(),
		order:      append([]tweet_tag.OrderOption{}, ttq.order...),
...
//		GroupBy(tweet_tag.FieldAddedAt).
...
func (ttq *TweetTagQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(tweet_tag.Table, tweet_tag.Columns, sqlgraph.NewFieldSpec(tweet_tag.FieldID, field.TypeUUID))
	_spec.From = ttq.sql
	...
	if fields := ttq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, tweet_tag.FieldID)
		for i := range fields {
			if fields[i] != tweet_tag.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if ttq.withTag != nil {
			_spec.Node.AddColumnOnce(tweet_tag.FieldTagID)
		}
		if ttq.withTweet != nil {
			_spec.Node.AddColumnOnce(tweet_tag.FieldTweetID)
		}
	}
...
func (ttq *TweetTagQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(tweet_tag.Table)
...
func (ttgb *TweetTagGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ttgb.build.ctx, fluent.OpQueryGroupBy)
...
func (tts *TweetTagSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, tts.ctx, fluent.OpQuerySelect)
