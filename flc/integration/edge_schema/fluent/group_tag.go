...
func (*GroupTag) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group_tag.FieldID, group_tag.FieldTagID, group_tag.FieldGroupID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the GroupTag.
// This includes values selected through modifiers, order, etc.
func (gt *GroupTag) Value(name string) (fluent.Value, error) {
