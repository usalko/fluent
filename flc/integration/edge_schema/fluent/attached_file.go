...
func (*AttachedFile) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case attached_file.FieldID, attached_file.FieldFID, attached_file.FieldProcID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the AttachedFile.
// This includes values selected through modifiers, order, etc.
func (af *AttachedFile) Value(name string) (fluent.Value, error) {
