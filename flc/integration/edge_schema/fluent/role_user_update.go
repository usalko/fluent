...
func (ruu *RoleUserUpdate) SetCreatedAt(time_time time.Time) *RoleUserUpdate {
	ruu.mutation.SetCreatedAt(time_time)
	return ruu
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (ruu *RoleUserUpdate) SetNillableCreatedAt(time_time *time.Time) *RoleUserUpdate {
	if time_time != nil {
		ruu.SetCreatedAt(*time_time)
	}
	return ruu
}
...
func (ruu *RoleUserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(role_user.Table, role_user.Columns, sqlgraph.NewFieldSpec(role_user.FieldUserID, field.TypeInt), sqlgraph.NewFieldSpec(role_user.FieldRoleID, field.TypeInt))
	...
	if value, ok := ruu.mutation.CreatedAt(); ok {
		_spec.SetField(role_user.FieldCreatedAt, field.TypeTime, value)
	}
	...
	if n, err = sqlgraph.UpdateNodes(ctx, ruu.driver, _spec); err != nil {
		if _, ok := err.(*sqlgraph.NotFoundError); ok {
			err = &NotFoundError{role_user.Label}
...
// SetCreatedAt sets the "created_at" field.
func (ruuo *RoleUserUpdateOne) SetCreatedAt(time_time time.Time) *RoleUserUpdateOne {
	ruuo.mutation.SetCreatedAt(time_time)
	return ruuo
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (ruuo *RoleUserUpdateOne) SetNillableCreatedAt(time_time *time.Time) *RoleUserUpdateOne {
	if time_time != nil {
		ruuo.SetCreatedAt(*time_time)
	}
	return ruuo
}
