...
func (*TweetTag) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case tweet_tag.FieldTagID, tweet_tag.FieldTweetID:
			values[i] = new(sql.NullInt64)
		case tweet_tag.FieldAddedAt:
			values[i] = new(sql.NullTime)
		case tweet_tag.FieldID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the TweetTag.
// This includes values selected through modifiers, order, etc.
func (tt *TweetTag) Value(name string) (fluent.Value, error) {
