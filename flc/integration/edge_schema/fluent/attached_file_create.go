...
func (afc *AttachedFileCreate) SetAttachTime(time_time time.Time) *AttachedFileCreate {
	afc.mutation.SetAttachTime(time_time)
	return afc
}

// SetNillableAttachTime sets the "attach_time" field if the given value is not nil.
func (afc *AttachedFileCreate) SetNillableAttachTime(time_time *time.Time) *AttachedFileCreate {
	if time_time != nil {
		afc.SetAttachTime(*time_time)
	}
	return afc
}
...
func (afc *AttachedFileCreate) defaults() {
	if _, ok := afc.mutation.AttachTime(); !ok {
		v := attached_file.DefaultAttachTime()
...
func (afc *AttachedFileCreate) createSpec() (*AttachedFile, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(attached_file.Table, sqlgraph.NewFieldSpec(attached_file.FieldID, field.TypeInt))
	)
	_spec.OnConflict = afc.conflict
	if value, ok := afc.mutation.AttachTime(); ok {
		_spec.SetField(attached_file.FieldAttachTime, field.TypeTime, value)
...
//		// update values.
//		Update(func(u *fluent.AttachedFileUpsert) {
//			SetAttachTime(v+v).
//		}).
//		Exec(ctx)
...
func (u *AttachedFileUpsert) SetAttachTime(v time.Time) *AttachedFileUpsert {
	u.Set(attached_file.FieldAttachTime, v)
	return u
}
...
func (u *AttachedFileUpsert) UpdateAttachTime() *AttachedFileUpsert {
	u.SetExcluded(attached_file.FieldAttachTime)
	return u
}

// SetFID sets the "f_id" field.
func (u *AttachedFileUpsert) SetFID(v int) *AttachedFileUpsert {
	u.Set(attached_file.FieldFID, v)
	return u
}
...
func (u *AttachedFileUpsert) UpdateFID() *AttachedFileUpsert {
	u.SetExcluded(attached_file.FieldFID)
	return u
}

// SetProcID sets the "proc_id" field.
func (u *AttachedFileUpsert) SetProcID(v int) *AttachedFileUpsert {
	u.Set(attached_file.FieldProcID, v)
	return u
}
...
func (u *AttachedFileUpsert) UpdateProcID() *AttachedFileUpsert {
	u.SetExcluded(attached_file.FieldProcID)
	return u
}
