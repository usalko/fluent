...
func (ruq *RoleUserQuery) Order(o ...role_user.OrderOption) *RoleUserQuery {
...
func (ruq *RoleUserQuery) QueryRole() *RoleQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(role_user.Table, role_user.RoleColumn, selector),
			sqlgraph.To(role.Table, role.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, role_user.RoleTable, role_user.RoleColumn),
		)
...
func (ruq *RoleUserQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(role_user.Table, role_user.UserColumn, selector),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, role_user.UserTable, role_user.UserColumn),
		)
		fromU = sqlgraph.SetNeighbors(ruq.driver.Dialect(), step)
		return fromU, nil
	}
...
func (ruq *RoleUserQuery) First(ctx context.Context) (*RoleUser, error) {
	nodes, err := ruq.Limit(1).All(setContextOp(ctx, ruq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{role_user.Label}
	}
	return nodes[0], nil
}
...
func (ruq *RoleUserQuery) Only(ctx context.Context) (*RoleUser, error) {
	nodes, err := ruq.Limit(2).All(setContextOp(ctx, ruq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{role_user.Label}
	default:
		return nil, &NotSingularError{role_user.Label}
	}
}
...
func (ruq *RoleUserQuery) All(ctx context.Context) ([]*RoleUser, error) {
	ctx = setContextOp(ctx, ruq.ctx, fluent.OpQueryAll)
	if err := ruq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (ruq *RoleUserQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, ruq.ctx, fluent.OpQueryCount)
	if err := ruq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (ruq *RoleUserQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, ruq.ctx, fluent.OpQueryExist)
...
func (ruq *RoleUserQuery) Clone() *RoleUserQuery {
	...
	return &RoleUserQuery{
		config:     ruq.config,
		ctx:        ruq.ctx.Clone(),
		order:      append([]role_user.OrderOption{}, ruq.order...),
...
//		GroupBy(role_user.FieldCreatedAt).
...
//
//	client.RoleUser.Query().
//		Select(role_user.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (ruq *RoleUserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(role_user.Table, role_user.Columns, nil)
	_spec.From = ruq.sql
	...
	if fields := ruq.ctx.Fields; len(fields) > 0 {
		...
		if ruq.withRole != nil {
			_spec.Node.AddColumnOnce(role_user.FieldRoleID)
		}
		if ruq.withUser != nil {
			_spec.Node.AddColumnOnce(role_user.FieldUserID)
		}
	}
...
func (ruq *RoleUserQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(role_user.Table)
...
func (rugb *RoleUserGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, rugb.build.ctx, fluent.OpQueryGroupBy)
...
func (rus *RoleUserSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, rus.ctx, fluent.OpQuerySelect)
