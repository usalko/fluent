...
func (ugq *UserGroupQuery) Order(o ...user_group.OrderOption) *UserGroupQuery {
...
func (ugq *UserGroupQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(user_group.Table, user_group.FieldID, selector),
...
func (ugq *UserGroupQuery) First(ctx context.Context) (*UserGroup, error) {
	nodes, err := ugq.Limit(1).All(setContextOp(ctx, ugq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{user_group.Label}
	}
	return nodes[0], nil
}
...
func (ugq *UserGroupQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = ugq.Limit(1).IDs(setContextOp(ctx, ugq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (ugq *UserGroupQuery) Only(ctx context.Context) (*UserGroup, error) {
	nodes, err := ugq.Limit(2).All(setContextOp(ctx, ugq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{user_group.Label}
	default:
		return nil, &NotSingularError{user_group.Label}
	}
}
...
func (ugq *UserGroupQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = ugq.Limit(2).IDs(setContextOp(ctx, ugq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{user_group.Label}
	default:
		err = &NotSingularError{user_group.Label}
	}
	return
}
...
func (ugq *UserGroupQuery) All(ctx context.Context) ([]*UserGroup, error) {
	ctx = setContextOp(ctx, ugq.ctx, fluent.OpQueryAll)
	if err := ugq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (ugq *UserGroupQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, ugq.ctx, fluent.OpQueryIDs)
	if err = ugq.Select(user_group.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (ugq *UserGroupQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, ugq.ctx, fluent.OpQueryCount)
	if err := ugq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (ugq *UserGroupQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, ugq.ctx, fluent.OpQueryExist)
...
func (ugq *UserGroupQuery) Clone() *UserGroupQuery {
	...
	return &UserGroupQuery{
		config:     ugq.config,
		ctx:        ugq.ctx.Clone(),
		order:      append([]user_group.OrderOption{}, ugq.order...),
...
//		GroupBy(user_group.FieldJoinedAt).
...
func (ugq *UserGroupQuery) GroupBy(field string, fields ...string) *UserGroupGroupBy {
	...
	grbuild.label = user_group.Label
...
//
//	client.UserGroup.Query().
//		Select(user_group.FieldJoinedAt).
//		Scan(ctx, &v)
...
func (ugq *UserGroupQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(user_group.Table, user_group.Columns, sqlgraph.NewFieldSpec(user_group.FieldID, field.TypeInt))
	_spec.From = ugq.sql
	...
	if fields := ugq.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != user_group.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if ugq.withUser != nil {
			_spec.Node.AddColumnOnce(user_group.FieldUserID)
		}
		if ugq.withGroup != nil {
			_spec.Node.AddColumnOnce(user_group.FieldGroupID)
		}
	}
...
func (ugq *UserGroupQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(user_group.Table)
...
func (uggb *UserGroupGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, uggb.build.ctx, fluent.OpQueryGroupBy)
...
func (ugs *UserGroupSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ugs.ctx, fluent.OpQuerySelect)
