...
// Filter returns an fluent_ql.Where implementation to apply filters on the AttachedFileMutation builder.
...
func (f *AttachedFileFilter) Where(p fluent_ql.P) {
...
func (f *AttachedFileFilter) WhereHasFiWith(preds ...predicate.File) {
	f.Where(fluent_ql.HasEdgeWith("fi", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *AttachedFileFilter) WhereHasProc() {
	f.Where(fluent_ql.HasEdge("proc"))
}
...
func (f *AttachedFileFilter) WhereHasProcWith(preds ...predicate.Process) {
	f.Where(fluent_ql.HasEdgeWith("proc", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *FileFilter) WhereHasProcesses() {
	f.Where(fluent_ql.HasEdge("processes"))
}
...
func (f *FileFilter) WhereHasProcessesWith(preds ...predicate.Process) {
	f.Where(fluent_ql.HasEdgeWith("processes", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the FriendshipMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *FriendshipFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the fluent_ql int predicate on the id field.
func (f *FriendshipFilter) WhereID(p fluent_ql.IntP) {
	f.Where(p.Field(friendship.FieldID))
}

// WhereWeight applies the fluent_ql int predicate on the weight field.
func (f *FriendshipFilter) WhereWeight(p fluent_ql.IntP) {
	f.Where(p.Field(friendship.FieldWeight))
}

// WhereCreatedAt applies the fluent_ql time.Time predicate on the created_at field.
func (f *FriendshipFilter) WhereCreatedAt(p fluent_ql.TimeP) {
	f.Where(p.Field(friendship.FieldCreatedAt))
}

// WhereUserID applies the fluent_ql int predicate on the user_id field.
func (f *FriendshipFilter) WhereUserID(p fluent_ql.IntP) {
	f.Where(p.Field(friendship.FieldUserID))
}

// WhereFriendID applies the fluent_ql int predicate on the friend_id field.
func (f *FriendshipFilter) WhereFriendID(p fluent_ql.IntP) {
	f.Where(p.Field(friendship.FieldFriendID))
}

// WhereHasUser applies a predicate to check if query has an edge user.
func (f *FriendshipFilter) WhereHasUser() {
	f.Where(fluent_ql.HasEdge("user"))
}

// WhereHasUserWith applies a predicate to check if query has an edge user with a given conditions (other predicates).
func (f *FriendshipFilter) WhereHasUserWith(preds ...predicate.User) {
	f.Where(fluent_ql.HasEdgeWith("user", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *FriendshipFilter) WhereHasFriend() {
	f.Where(fluent_ql.HasEdge("friend"))
}
...
func (f *FriendshipFilter) WhereHasFriendWith(preds ...predicate.User) {
	f.Where(fluent_ql.HasEdgeWith("friend", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *GroupFilter) WhereHasTags() {
	f.Where(fluent_ql.HasEdge("tags"))
}
...
func (f *GroupFilter) WhereHasTagsWith(preds ...predicate.Tag) {
	f.Where(fluent_ql.HasEdgeWith("tags", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *GroupFilter) WhereHasJoinedUsers() {
	f.Where(fluent_ql.HasEdge("joined_users"))
}
...
func (f *GroupFilter) WhereHasJoinedUsersWith(preds ...predicate.UserGroup) {
	f.Where(fluent_ql.HasEdgeWith("joined_users", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *GroupFilter) WhereHasGroupTags() {
	f.Where(fluent_ql.HasEdge("group_tags"))
}
...
func (f *GroupFilter) WhereHasGroupTagsWith(preds ...predicate.GroupTag) {
	f.Where(fluent_ql.HasEdgeWith("group_tags", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the GroupTagMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *GroupTagFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
func (f *GroupTagFilter) WhereHasTagWith(preds ...predicate.Tag) {
	f.Where(fluent_ql.HasEdgeWith("tag", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *GroupTagFilter) WhereHasGroup() {
	f.Where(fluent_ql.HasEdge("group"))
}
...
func (f *GroupTagFilter) WhereHasGroupWith(preds ...predicate.Group) {
	f.Where(fluent_ql.HasEdgeWith("group", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the ProcessMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *ProcessFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the fluent_ql int predicate on the id field.
func (f *ProcessFilter) WhereID(p fluent_ql.IntP) {
...
func (f *ProcessFilter) WhereHasAttachedFiles() {
	f.Where(fluent_ql.HasEdge("attached_files"))
}
...
func (f *ProcessFilter) WhereHasAttachedFilesWith(preds ...predicate.AttachedFile) {
	f.Where(fluent_ql.HasEdgeWith("attached_files", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the RelationshipMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *RelationshipFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereWeight applies the fluent_ql int predicate on the weight field.
func (f *RelationshipFilter) WhereWeight(p fluent_ql.IntP) {
	f.Where(p.Field(relationship.FieldWeight))
}

// WhereUserID applies the fluent_ql int predicate on the user_id field.
func (f *RelationshipFilter) WhereUserID(p fluent_ql.IntP) {
	f.Where(p.Field(relationship.FieldUserID))
}

// WhereRelativeID applies the fluent_ql int predicate on the relative_id field.
func (f *RelationshipFilter) WhereRelativeID(p fluent_ql.IntP) {
	f.Where(p.Field(relationship.FieldRelativeID))
}

// WhereInfoID applies the fluent_ql int predicate on the info_id field.
func (f *RelationshipFilter) WhereInfoID(p fluent_ql.IntP) {
...
func (f *RelationshipFilter) WhereHasRelative() {
	f.Where(fluent_ql.HasEdge("relative"))
}
...
func (f *RelationshipFilter) WhereHasRelativeWith(preds ...predicate.User) {
	f.Where(fluent_ql.HasEdgeWith("relative", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the RelationshipInfoMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *RelationshipInfoFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// Filter returns an fluent_ql.Where implementation to apply filters on the RoleMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *RoleFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the fluent_ql int predicate on the id field.
func (f *RoleFilter) WhereID(p fluent_ql.IntP) {
	f.Where(p.Field(role.FieldID))
}

// WhereName applies the fluent_ql string predicate on the name field.
func (f *RoleFilter) WhereName(p fluent_ql.StringP) {
	f.Where(p.Field(role.FieldName))
}

// WhereCreatedAt applies the fluent_ql time.Time predicate on the created_at field.
func (f *RoleFilter) WhereCreatedAt(p fluent_ql.TimeP) {
...
func (f *RoleFilter) WhereHasRolesUsers() {
	f.Where(fluent_ql.HasEdge("roles_users"))
}
...
func (f *RoleFilter) WhereHasRolesUsersWith(preds ...predicate.RoleUser) {
	f.Where(fluent_ql.HasEdgeWith("roles_users", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the RoleUserMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *RoleUserFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
func (f *RoleUserFilter) WhereHasRole() {
	f.Where(fluent_ql.HasEdge("role"))
}
...
func (f *RoleUserFilter) WhereHasRoleWith(preds ...predicate.Role) {
	f.Where(fluent_ql.HasEdgeWith("role", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the TagMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *TagFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the fluent_ql int predicate on the id field.
func (f *TagFilter) WhereID(p fluent_ql.IntP) {
	f.Where(p.Field(tag.FieldID))
}

// WhereValue applies the fluent_ql string predicate on the value field.
func (f *TagFilter) WhereValue(p fluent_ql.StringP) {
...
func (f *TagFilter) WhereHasTweets() {
	f.Where(fluent_ql.HasEdge("tweets"))
}
...
func (f *TagFilter) WhereHasTweetsWith(preds ...predicate.Tweet) {
	f.Where(fluent_ql.HasEdgeWith("tweets", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *TagFilter) WhereHasTweetTags() {
	f.Where(fluent_ql.HasEdge("tweet_tags"))
}
...
func (f *TagFilter) WhereHasTweetTagsWith(preds ...predicate.TweetTag) {
	f.Where(fluent_ql.HasEdgeWith("tweet_tags", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the TweetMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *TweetFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the fluent_ql int predicate on the id field.
func (f *TweetFilter) WhereID(p fluent_ql.IntP) {
	f.Where(p.Field(tweet.FieldID))
}

// WhereText applies the fluent_ql string predicate on the text field.
func (f *TweetFilter) WhereText(p fluent_ql.StringP) {
...
func (f *TweetFilter) WhereHasLikedUsers() {
	f.Where(fluent_ql.HasEdge("liked_users"))
}
...
func (f *TweetFilter) WhereHasLikedUsersWith(preds ...predicate.User) {
	f.Where(fluent_ql.HasEdgeWith("liked_users", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *TweetFilter) WhereHasLikes() {
	f.Where(fluent_ql.HasEdge("likes"))
}
...
func (f *TweetFilter) WhereHasLikesWith(preds ...predicate.TweetLike) {
	f.Where(fluent_ql.HasEdgeWith("likes", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *TweetFilter) WhereHasTweetUser() {
	f.Where(fluent_ql.HasEdge("tweet_user"))
}
...
func (f *TweetFilter) WhereHasTweetUserWith(preds ...predicate.UserTweet) {
	f.Where(fluent_ql.HasEdgeWith("tweet_user", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the TweetLikeMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *TweetLikeFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
func (f *TweetLikeFilter) WhereHasTweet() {
	f.Where(fluent_ql.HasEdge("tweet"))
}
...
func (f *TweetLikeFilter) WhereHasTweetWith(preds ...predicate.Tweet) {
	f.Where(fluent_ql.HasEdgeWith("tweet", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the TweetTagMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *TweetTagFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
func (f *UserFilter) WhereHasRelatives() {
	f.Where(fluent_ql.HasEdge("relatives"))
}
...
func (f *UserFilter) WhereHasRelativesWith(preds ...predicate.User) {
	f.Where(fluent_ql.HasEdgeWith("relatives", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *UserFilter) WhereHasLikedTweets() {
	f.Where(fluent_ql.HasEdge("liked_tweets"))
}
...
func (f *UserFilter) WhereHasLikedTweetsWith(preds ...predicate.Tweet) {
	f.Where(fluent_ql.HasEdgeWith("liked_tweets", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *UserFilter) WhereHasRoles() {
	f.Where(fluent_ql.HasEdge("roles"))
}
...
func (f *UserFilter) WhereHasRolesWith(preds ...predicate.Role) {
	f.Where(fluent_ql.HasEdgeWith("roles", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *UserFilter) WhereHasJoinedGroups() {
	f.Where(fluent_ql.HasEdge("joined_groups"))
}
...
func (f *UserFilter) WhereHasJoinedGroupsWith(preds ...predicate.UserGroup) {
	f.Where(fluent_ql.HasEdgeWith("joined_groups", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *UserFilter) WhereHasFriendships() {
	f.Where(fluent_ql.HasEdge("friendships"))
}
...
func (f *UserFilter) WhereHasFriendshipsWith(preds ...predicate.Friendship) {
	f.Where(fluent_ql.HasEdgeWith("friendships", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *UserFilter) WhereHasRelationship() {
	f.Where(fluent_ql.HasEdge("relationship"))
}
...
func (f *UserFilter) WhereHasRelationshipWith(preds ...predicate.Relationship) {
	f.Where(fluent_ql.HasEdgeWith("relationship", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *UserFilter) WhereHasUserTweets() {
	f.Where(fluent_ql.HasEdge("user_tweets"))
}
...
func (f *UserFilter) WhereHasUserTweetsWith(preds ...predicate.UserTweet) {
	f.Where(fluent_ql.HasEdgeWith("user_tweets", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// Filter returns an fluent_ql.Where implementation to apply filters on the UserGroupMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *UserGroupFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// Filter returns an fluent_ql.Where implementation to apply filters on the UserTweetMutation builder.
...
// Where applies the fluent_ql predicate on the query filter.
func (f *UserTweetFilter) Where(p fluent_ql.P) {
	f.addPredicate(func(s *sql.Selector) {
