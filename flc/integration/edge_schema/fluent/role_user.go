...
func (*RoleUser) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case role_user.FieldRoleID, role_user.FieldUserID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the RoleUser.
// This includes values selected through modifiers, order, etc.
func (ru *RoleUser) Value(name string) (fluent.Value, error) {
...
func (ru *RoleUser) Unwrap() *RoleUser {
	...
	if !ok {
		panic("fluent: RoleUser is not a transactional entity")
	}
