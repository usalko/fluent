...
type RelationshipInfoQuery struct {
	config
	ctx        *QueryContext
	order      []relationship_info.OrderOption
	inters     []Interceptor
...
func (riq *RelationshipInfoQuery) Order(o ...relationship_info.OrderOption) *RelationshipInfoQuery {
...
func (riq *RelationshipInfoQuery) First(ctx context.Context) (*RelationshipInfo, error) {
	nodes, err := riq.Limit(1).All(setContextOp(ctx, riq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{relationship_info.Label}
	}
	return nodes[0], nil
}
...
func (riq *RelationshipInfoQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = riq.Limit(1).IDs(setContextOp(ctx, riq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{relationship_info.Label}
		return
	}
	return ids[0], nil
}
...
func (riq *RelationshipInfoQuery) Only(ctx context.Context) (*RelationshipInfo, error) {
	nodes, err := riq.Limit(2).All(setContextOp(ctx, riq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{relationship_info.Label}
	default:
		return nil, &NotSingularError{relationship_info.Label}
	}
}
...
func (riq *RelationshipInfoQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = riq.Limit(2).IDs(setContextOp(ctx, riq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{relationship_info.Label}
	default:
		err = &NotSingularError{relationship_info.Label}
	}
	return
}
...
func (riq *RelationshipInfoQuery) All(ctx context.Context) ([]*RelationshipInfo, error) {
	ctx = setContextOp(ctx, riq.ctx, fluent.OpQueryAll)
...
func (riq *RelationshipInfoQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, riq.ctx, fluent.OpQueryIDs)
	if err = riq.Select(relationship_info.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (riq *RelationshipInfoQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, riq.ctx, fluent.OpQueryCount)
	if err := riq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (riq *RelationshipInfoQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, riq.ctx, fluent.OpQueryExist)
...
func (riq *RelationshipInfoQuery) Clone() *RelationshipInfoQuery {
	...
	return &RelationshipInfoQuery{
		config:     riq.config,
		ctx:        riq.ctx.Clone(),
		order:      append([]relationship_info.OrderOption{}, riq.order...),
...
//		GroupBy(relationship_info.FieldText).
...
func (riq *RelationshipInfoQuery) GroupBy(field string, fields ...string) *RelationshipInfoGroupBy {
	...
	grbuild.label = relationship_info.Label
...
//
//	client.RelationshipInfo.Query().
//		Select(relationship_info.FieldText).
//		Scan(ctx, &v)
func (riq *RelationshipInfoQuery) Select(fields ...string) *RelationshipInfoSelect {
	...
	sbuild.label = relationship_info.Label
...
func (riq *RelationshipInfoQuery) prepareQuery(ctx context.Context) error {
	...
	for _, f := range riq.ctx.Fields {
		if !relationship_info.ValidColumn(f) {
...
func (riq *RelationshipInfoQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(relationship_info.Table, relationship_info.Columns, sqlgraph.NewFieldSpec(relationship_info.FieldID, field.TypeInt))
	_spec.From = riq.sql
	...
	if fields := riq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, relationship_info.FieldID)
		for i := range fields {
			if fields[i] != relationship_info.FieldID {
...
func (riq *RelationshipInfoQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(relationship_info.Table)
...
func (rigb *RelationshipInfoGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, rigb.build.ctx, fluent.OpQueryGroupBy)
...
func (ris *RelationshipInfoSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ris.ctx, fluent.OpQuerySelect)
