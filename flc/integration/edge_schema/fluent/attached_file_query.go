...
type AttachedFileQuery struct {
	config
	ctx        *QueryContext
	order      []attached_file.OrderOption
	inters     []Interceptor
...
func (afq *AttachedFileQuery) Order(o ...attached_file.OrderOption) *AttachedFileQuery {
...
func (afq *AttachedFileQuery) QueryFi() *FileQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(attached_file.Table, attached_file.FieldID, selector),
...
func (afq *AttachedFileQuery) First(ctx context.Context) (*AttachedFile, error) {
	nodes, err := afq.Limit(1).All(setContextOp(ctx, afq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{attached_file.Label}
	}
	return nodes[0], nil
}
...
func (afq *AttachedFileQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = afq.Limit(1).IDs(setContextOp(ctx, afq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{attached_file.Label}
		return
	}
	return ids[0], nil
}
...
func (afq *AttachedFileQuery) Only(ctx context.Context) (*AttachedFile, error) {
	nodes, err := afq.Limit(2).All(setContextOp(ctx, afq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{attached_file.Label}
	default:
		return nil, &NotSingularError{attached_file.Label}
	}
}
...
func (afq *AttachedFileQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = afq.Limit(2).IDs(setContextOp(ctx, afq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{attached_file.Label}
	default:
		err = &NotSingularError{attached_file.Label}
	}
	return
}
...
func (afq *AttachedFileQuery) All(ctx context.Context) ([]*AttachedFile, error) {
	ctx = setContextOp(ctx, afq.ctx, fluent.OpQueryAll)
	if err := afq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (afq *AttachedFileQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, afq.ctx, fluent.OpQueryIDs)
	if err = afq.Select(attached_file.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (afq *AttachedFileQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, afq.ctx, fluent.OpQueryCount)
	if err := afq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (afq *AttachedFileQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, afq.ctx, fluent.OpQueryExist)
...
func (afq *AttachedFileQuery) Clone() *AttachedFileQuery {
	...
	return &AttachedFileQuery{
		config:     afq.config,
		ctx:        afq.ctx.Clone(),
		order:      append([]attached_file.OrderOption{}, afq.order...),
...
//		GroupBy(attached_file.FieldAttachTime).
...
func (afq *AttachedFileQuery) GroupBy(field string, fields ...string) *AttachedFileGroupBy {
	...
	grbuild.label = attached_file.Label
...
//
//	client.AttachedFile.Query().
//		Select(attached_file.FieldAttachTime).
//		Scan(ctx, &v)
func (afq *AttachedFileQuery) Select(fields ...string) *AttachedFileSelect {
	...
	sbuild.label = attached_file.Label
...
func (afq *AttachedFileQuery) prepareQuery(ctx context.Context) error {
	...
	for _, f := range afq.ctx.Fields {
		if !attached_file.ValidColumn(f) {
...
func (afq *AttachedFileQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(attached_file.Table, attached_file.Columns, sqlgraph.NewFieldSpec(attached_file.FieldID, field.TypeInt))
	_spec.From = afq.sql
	...
	if fields := afq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, attached_file.FieldID)
		for i := range fields {
			if fields[i] != attached_file.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if afq.withFi != nil {
			_spec.Node.AddColumnOnce(attached_file.FieldFID)
		}
		if afq.withProc != nil {
			_spec.Node.AddColumnOnce(attached_file.FieldProcID)
		}
	}
...
func (afq *AttachedFileQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(attached_file.Table)
...
func (afgb *AttachedFileGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, afgb.build.ctx, fluent.OpQueryGroupBy)
...
func (afs *AttachedFileSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, afs.ctx, fluent.OpQuerySelect)
