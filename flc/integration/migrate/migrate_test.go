...
import (
	...
	migratev1 "github.com/usalko/fluent/flc/integration/migrate/fluentv1/migrate"
	userv1 "github.com/usalko/fluent/flc/integration/migrate/fluentv1/user"
	...
	migratev2 "github.com/usalko/fluent/flc/integration/migrate/fluentv2/migrate"
	...
	"github.com/usalko/fluent/flc/integration/migrate/fluentv2/zoo"
	"github.com/usalko/fluent/flc/integration/migrate/versioned"
	vmigrate "github.com/usalko/fluent/flc/integration/migrate/versioned/migrate"
...
// https://github.com/usalko/fluent/issues/2954
...
func CheckConstraint(t *testing.T, client *entv2.Client) {
	...
	require.Error(t, err)
	err = client.Media.Create().SetSourceURI("github.com/usalko/fluent").Exec(ctx)
	require.Error(t, err)
}
