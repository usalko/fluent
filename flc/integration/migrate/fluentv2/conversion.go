...
// Value returns the fluent.Value that was dynamically selected and assigned to the Conversion.
// This includes values selected through modifiers, order, etc.
func (c *Conversion) Value(name string) (fluent.Value, error) {
...
func (c *Conversion) Unwrap() *Conversion {
	...
	if !ok {
		panic("fluentv2: Conversion is not a transactional entity")
	}
