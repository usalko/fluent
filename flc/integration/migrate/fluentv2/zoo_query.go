...
func (zq *ZooQuery) First(ctx context.Context) (*Zoo, error) {
	nodes, err := zq.Limit(1).All(setContextOp(ctx, zq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (zq *ZooQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = zq.Limit(1).IDs(setContextOp(ctx, zq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (zq *ZooQuery) Only(ctx context.Context) (*Zoo, error) {
	nodes, err := zq.Limit(2).All(setContextOp(ctx, zq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (zq *ZooQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = zq.Limit(2).IDs(setContextOp(ctx, zq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (zq *ZooQuery) All(ctx context.Context) ([]*Zoo, error) {
	ctx = setContextOp(ctx, zq.ctx, fluent.OpQueryAll)
...
func (zq *ZooQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, zq.ctx, fluent.OpQueryIDs)
...
func (zq *ZooQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, zq.ctx, fluent.OpQueryCount)
	if err := zq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (zq *ZooQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, zq.ctx, fluent.OpQueryExist)
...
func (zgb *ZooGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, zgb.build.ctx, fluent.OpQueryGroupBy)
...
func (zs *ZooSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, zs.ctx, fluent.OpQuerySelect)
