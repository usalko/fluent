...
func (*CustomType) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case custom_type.FieldID:
			values[i] = new(sql.NullInt64)
		case custom_type.FieldCustom:
			values[i] = new(sql.NullString)
		case custom_type.FieldTz0, custom_type.FieldTz3:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the CustomType.
// This includes values selected through modifiers, order, etc.
func (ct *CustomType) Value(name string) (fluent.Value, error) {
...
func (ct *CustomType) Unwrap() *CustomType {
	...
	if !ok {
		panic("fluentv2: CustomType is not a transactional entity")
	}
