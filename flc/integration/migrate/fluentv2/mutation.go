...
var _ fluent.Mutation = (*BlogMutation)(nil)
...
// schema.
func (m *BlogMutation) Field(name string) (fluent.Value, bool) {
	switch name {
	case blog.FieldOid:
		return m.Oid()
	}
...
// database failed.
func (m *BlogMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case blog.FieldOid:
		return m.OldOid(ctx)
	}
...
// type.
func (m *BlogMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case blog.FieldOid:
		v, ok := value.(int)
		if !ok {
...
func (m *BlogMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	case blog.FieldOid:
		return m.AddedOid()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BlogMutation) AddField(name string, value fluent.Value) error {
	switch name {
	case blog.FieldOid:
		v, ok := value.(int)
		if !ok {
...
func (m *BlogMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case blog.EdgeAdmins:
		ids := make([]fluent.Value, 0, len(m.admins))
		for id := range m.admins {
			ids = append(ids, id)
		}
		return ids
...
func (m *BlogMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case blog.EdgeAdmins:
		ids := make([]fluent.Value, 0, len(m.removedadmins))
		for id := range m.removedadmins {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*ConversionMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ConversionMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ConversionMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case conversion.FieldName:
		return m.OldName(ctx)
	case conversion.FieldInt8ToString:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ConversionMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case conversion.FieldName:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ConversionMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ConversionMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ConversionMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ConversionMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*CustomTypeMutation)(nil)
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *CustomTypeMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CustomTypeMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *CustomTypeMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *CustomTypeMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*MediaMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *MediaMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *MediaMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case media.FieldSource:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MediaMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case media.FieldSource:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *MediaMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MediaMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *MediaMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *MediaMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
func (m *UserMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case user.EdgeCar:
		ids := make([]fluent.Value, 0, len(m.car))
		for id := range m.car {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case user.EdgeCar:
		ids := make([]fluent.Value, 0, len(m.removedcar))
		for id := range m.removedcar {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*ZooMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ZooMutation) Field(name string) (fluent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ZooMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ZooMutation) SetField(name string, value fluent.Value) error {
	switch name {
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ZooMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ZooMutation) AddField(name string, value fluent.Value) error {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ZooMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ZooMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
