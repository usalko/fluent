...
func (ctq *CustomTypeQuery) Order(o ...custom_type.OrderOption) *CustomTypeQuery {
...
func (ctq *CustomTypeQuery) First(ctx context.Context) (*CustomType, error) {
	nodes, err := ctq.Limit(1).All(setContextOp(ctx, ctq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{custom_type.Label}
	}
	return nodes[0], nil
}
...
func (ctq *CustomTypeQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = ctq.Limit(1).IDs(setContextOp(ctx, ctq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{custom_type.Label}
		return
	}
	return ids[0], nil
}
...
func (ctq *CustomTypeQuery) Only(ctx context.Context) (*CustomType, error) {
	nodes, err := ctq.Limit(2).All(setContextOp(ctx, ctq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{custom_type.Label}
	default:
		return nil, &NotSingularError{custom_type.Label}
	}
}
...
func (ctq *CustomTypeQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = ctq.Limit(2).IDs(setContextOp(ctx, ctq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{custom_type.Label}
	default:
		err = &NotSingularError{custom_type.Label}
	}
	return
}
...
func (ctq *CustomTypeQuery) All(ctx context.Context) ([]*CustomType, error) {
	ctx = setContextOp(ctx, ctq.ctx, fluent.OpQueryAll)
...
func (ctq *CustomTypeQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, ctq.ctx, fluent.OpQueryIDs)
	if err = ctq.Select(custom_type.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (ctq *CustomTypeQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, ctq.ctx, fluent.OpQueryCount)
	if err := ctq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (ctq *CustomTypeQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, ctq.ctx, fluent.OpQueryExist)
...
func (ctq *CustomTypeQuery) Clone() *CustomTypeQuery {
	...
	return &CustomTypeQuery{
		config:     ctq.config,
		ctx:        ctq.ctx.Clone(),
		order:      append([]custom_type.OrderOption{}, ctq.order...),
...
//		GroupBy(custom_type.FieldCustom).
...
func (ctq *CustomTypeQuery) GroupBy(field string, fields ...string) *CustomTypeGroupBy {
	...
	grbuild.label = custom_type.Label
...
//
//	client.CustomType.Query().
//		Select(custom_type.FieldCustom).
//		Scan(ctx, &v)
func (ctq *CustomTypeQuery) Select(fields ...string) *CustomTypeSelect {
	...
	sbuild.label = custom_type.Label
...
func (ctq *CustomTypeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(custom_type.Table, custom_type.Columns, sqlgraph.NewFieldSpec(custom_type.FieldID, field.TypeInt))
	_spec.From = ctq.sql
	...
	if fields := ctq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, custom_type.FieldID)
		for i := range fields {
			if fields[i] != custom_type.FieldID {
...
func (ctq *CustomTypeQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(custom_type.Table)
	columns := ctq.ctx.Fields
	if len(columns) == 0 {
		columns = custom_type.Columns
	}
...
func (ctgb *CustomTypeGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ctgb.build.ctx, fluent.OpQueryGroupBy)
...
func (cts *CustomTypeSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, cts.ctx, fluent.OpQuerySelect)
