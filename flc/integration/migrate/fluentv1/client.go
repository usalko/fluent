...
var ErrTxStarted = errors.New("fluentv1: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("fluentv1: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluentv1: unknown mutation type %T", m)
	}
}
...
func (c *CarClient) mutate(ctx context.Context, m *CarMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluentv1: unknown Car mutation op: %q", m.Op())
	}
}
...
func (c *ConversionClient) mutate(ctx context.Context, m *ConversionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluentv1: unknown Conversion mutation op: %q", m.Op())
	}
}
...
func (c *CustomTypeClient) mutate(ctx context.Context, m *CustomTypeMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluentv1: unknown CustomType mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluentv1: unknown User mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Car, Conversion, CustomType, User []fluent.Hook
	}
	inters struct {
		Car, Conversion, CustomType, User []fluent.Interceptor
	}
)
