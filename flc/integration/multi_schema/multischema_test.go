...
import (
	...
	"github.com/usalko/fluent/flc/integration/multi_schema/fluent"
	"github.com/usalko/fluent/flc/integration/multi_schema/fluent/friendship"
	"github.com/usalko/fluent/flc/integration/multi_schema/fluent/group"
	"github.com/usalko/fluent/flc/integration/multi_schema/fluent/migrate"
	"github.com/usalko/fluent/flc/integration/multi_schema/fluent/pet"
	"github.com/usalko/fluent/flc/integration/multi_schema/fluent/user"
	"github.com/usalko/fluent/flc/integration/multi_schema/versioned"
	vgroup "github.com/usalko/fluent/flc/integration/multi_schema/versioned/group"
	vpet "github.com/usalko/fluent/flc/integration/multi_schema/versioned/pet"
	vuser "github.com/usalko/fluent/flc/integration/multi_schema/versioned/user"
...
func TestMySQL(t *testing.T) {
	...
	client := fluent.NewClient(fluent.Driver(db1), fluent.AlternateSchema(cfg))
	...
	users := client.User.Query().WithFriends().WithFriendships().WithGroups().Order(fluent.Asc(user.FieldName)).AllX(ctx)
...
func setupSchema(t *testing.T, client *fluent.Client, cfg fluent.SchemaConfig) {
