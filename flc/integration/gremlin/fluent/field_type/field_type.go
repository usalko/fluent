...
func StateValidator(s State) error {
	...
	case StateOn, StateOff:
		return nil
	default:
		return fmt.Errorf("field_type: invalid enum value for state field: %q", s)
	}
}
...
func RoleValidator(r role.Role) error {
	...
	case "ADMIN", "OWNER", "USER", "READ", "WRITE", "READ+WRITE":
		return nil
	default:
		return fmt.Errorf("field_type: invalid enum value for role field: %q", r)
	}
}
...
func PriorityValidator(pr role.Priority) error {
	...
	case "UNKNOWN", "LOW", "HIGH":
		return nil
	default:
		return fmt.Errorf("field_type: invalid enum value for priority field: %q", pr)
	}
}
