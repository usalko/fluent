...
func (sq *SpecQuery) First(ctx context.Context) (*Spec, error) {
	nodes, err := sq.Limit(1).All(setContextOp(ctx, sq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (sq *SpecQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = sq.Limit(1).IDs(setContextOp(ctx, sq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (sq *SpecQuery) Only(ctx context.Context) (*Spec, error) {
	nodes, err := sq.Limit(2).All(setContextOp(ctx, sq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (sq *SpecQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = sq.Limit(2).IDs(setContextOp(ctx, sq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (sq *SpecQuery) All(ctx context.Context) ([]*Spec, error) {
	ctx = setContextOp(ctx, sq.ctx, fluent.OpQueryAll)
	if err := sq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (sq *SpecQuery) IDs(ctx context.Context) (ids []string, err error) {
	...
	ctx = setContextOp(ctx, sq.ctx, fluent.OpQueryIDs)
...
func (sq *SpecQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, sq.ctx, fluent.OpQueryCount)
	if err := sq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (sq *SpecQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, sq.ctx, fluent.OpQueryExist)
...
func (sgb *SpecGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, sgb.build.ctx, fluent.OpQueryGroupBy)
...
func (ss *SpecSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ss.ctx, fluent.OpQuerySelect)
