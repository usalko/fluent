...
func (c *InfoClient) mutate(ctx context.Context, m *InfoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Info mutation op: %q", m.Op())
	}
}
...
func (c *MetadataClient) mutate(ctx context.Context, m *MetadataMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Metadata mutation op: %q", m.Op())
	}
}
...
func (c *PostClient) mutate(ctx context.Context, m *PostMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Post mutation op: %q", m.Op())
	}
}
...
func (c *RentalClient) mutate(ctx context.Context, m *RentalMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Rental mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Car, Card, Info, Metadata, Node, Pet, Post, Rental, User []fluent.Hook
	}
	inters struct {
		Car, Card, Info, Metadata, Node, Pet, Post, Rental, User []fluent.Interceptor
	}
)
