...
import (
	...
	"github.com/usalko/fluent/flc/integration/edge_field/fluent/card"
...
func (m *CarMutation) AddedIDs(name string) []fluent.Value {
	...
	case car.EdgeRentals:
		ids := make([]fluent.Value, 0, len(m.rentals))
		for id := range m.rentals {
			ids = append(ids, id)
		}
		return ids
...
func (m *CarMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case car.EdgeRentals:
		ids := make([]fluent.Value, 0, len(m.removedrentals))
		for id := range m.removedrentals {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*InfoMutation)(nil)
...
func (m *InfoMutation) SetContent(json_rawmessage json.RawMessage) {
	m.content = &json_rawmessage
	m.appendcontent = nil
}
...
// AppendContent adds json_rawmessage to the "content" field.
func (m *InfoMutation) AppendContent(json_rawmessage json.RawMessage) {
	m.appendcontent = append(m.appendcontent, json_rawmessage...)
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *InfoMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *InfoMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case info.FieldContent:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *InfoMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case info.FieldContent:
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *InfoMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *InfoMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *InfoMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case info.EdgeUser:
		if id := m.user; id != nil {
			return []fluent.Value{*id}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *InfoMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*MetadataMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *MetadataMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *MetadataMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case metadata.FieldAge:
		return m.OldAge(ctx)
	case metadata.FieldParentID:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MetadataMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case metadata.FieldAge:
		v, ok := value.(int)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *MetadataMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	case metadata.FieldAge:
		return m.AddedAge()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MetadataMutation) AddField(name string, value fluent.Value) error {
	switch name {
	case metadata.FieldAge:
		v, ok := value.(int)
		if !ok {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *MetadataMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *MetadataMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case metadata.EdgeChildren:
...
var _ fluent.Mutation = (*PostMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *PostMutation) Field(name string) (fluent.Value, bool) {
	switch name {
	case post.FieldText:
		return m.Text()
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *PostMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case post.FieldText:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *PostMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case post.FieldText:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *PostMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *PostMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *PostMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *PostMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*RentalMutation)(nil)
...
func (m *RentalMutation) SetDate(time_time time.Time) {
	m.date = &time_time
}
...
func (m *RentalMutation) SetCarID(uuid_uuid uuid.UUID) {
	m.car = &uuid_uuid
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *RentalMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *RentalMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case rental.FieldDate:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RentalMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case rental.FieldDate:
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *RentalMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RentalMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *RentalMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *RentalMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
func (m *UserMutation) AddedIDs(name string) []fluent.Value {
	...
	case user.EdgeInfo:
		ids := make([]fluent.Value, 0, len(m.info))
		for id := range m.info {
			ids = append(ids, id)
		}
		return ids
...
func (m *UserMutation) RemovedIDs(name string) []fluent.Value {
	...
	case user.EdgeChildren:
		...
		return ids
	case user.EdgeInfo:
		ids := make([]fluent.Value, 0, len(m.removedinfo))
		for id := range m.removedinfo {
			ids = append(ids, id)
		}
		return ids
