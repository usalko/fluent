...
import (
	...
	"sync"
	"time"
		"github.com/usalko/fluent/flc/integration/json/fluent/predicate"
...
func (uu *UserUpdate) Where(ps ...predicate.User) *UserUpdate {
	...
	func (uu *UserUpdate) SetT(schema.t *schema.T) *UserUpdate {
		uu.mutation.SetT(schema.t)
		return uu
	}
	...
	func (uu *UserUpdate) SetURL(value *url.URL) *UserUpdate {
		uu.mutation.SetURL(value)
		return uu
	}
	...
	func (uu *UserUpdate) SetURLs(value []*url.URL) *UserUpdate {
		uu.mutation.SetURLs(value)
		return uu
	}
		...
		func (uu *UserUpdate) AppendURLs(value []*url.URL) *UserUpdate {
			uu.mutation.AppendURLs(value)
			return uu
		}
	...
	func (uu *UserUpdate) SetRaw(jrm json.RawMessage) *UserUpdate {
		uu.mutation.SetRaw(jrm)
		return uu
	}
		...
		// AppendRaw appends jrm to the "raw" field.
		func (uu *UserUpdate) AppendRaw(jrm json.RawMessage) *UserUpdate {
			uu.mutation.AppendRaw(jrm)
			return uu
		}
	...
	func (uu *UserUpdate) SetDirs(hd []http.Dir) *UserUpdate {
		uu.mutation.SetDirs(hd)
		return uu
	}
		...
		// AppendDirs appends hd to the "dirs" field.
		func (uu *UserUpdate) AppendDirs(hd []http.Dir) *UserUpdate {
			uu.mutation.AppendDirs(hd)
			return uu
		}
	...
	func (uu *UserUpdate) SetAddr(sa schema.Addr) *UserUpdate {
		uu.mutation.SetAddr(sa)
		return uu
	}
		...
		func (uu *UserUpdate) SetNillableAddr(sa *schema.Addr) *UserUpdate {
			if sa != nil {
				uu.SetAddr(*sa)
			}
			return uu
...
type UserUpdateOne struct {
	...
	// SetT sets the "t" field.
	func (uuo *UserUpdateOne) SetT(schema.t *schema.T) *UserUpdateOne {
		uuo.mutation.SetT(schema.t)
		return uuo
	}
	...
	// SetURL sets the "url" field.
	func (uuo *UserUpdateOne) SetURL(uu *url.URL) *UserUpdateOne {
		uuo.mutation.SetURL(uu)
		return uuo
	}
	...
	// SetURLs sets the "URLs" field.
	func (uuo *UserUpdateOne) SetURLs(uu []*url.URL) *UserUpdateOne {
		uuo.mutation.SetURLs(uu)
		return uuo
	}
		...
		// AppendURLs appends uu to the "URLs" field.
		func (uuo *UserUpdateOne) AppendURLs(uu []*url.URL) *UserUpdateOne {
			uuo.mutation.AppendURLs(uu)
			return uuo
		}
	...
	// SetRaw sets the "raw" field.
	func (uuo *UserUpdateOne) SetRaw(jrm json.RawMessage) *UserUpdateOne {
		uuo.mutation.SetRaw(jrm)
		return uuo
	}
		...
		// AppendRaw appends jrm to the "raw" field.
		func (uuo *UserUpdateOne) AppendRaw(jrm json.RawMessage) *UserUpdateOne {
			uuo.mutation.AppendRaw(jrm)
			return uuo
		}
	...
	// SetDirs sets the "dirs" field.
	func (uuo *UserUpdateOne) SetDirs(hd []http.Dir) *UserUpdateOne {
		uuo.mutation.SetDirs(hd)
		return uuo
	}
		...
		// AppendDirs appends hd to the "dirs" field.
		func (uuo *UserUpdateOne) AppendDirs(hd []http.Dir) *UserUpdateOne {
			uuo.mutation.AppendDirs(hd)
			return uuo
		}
	...
	// SetAddr sets the "addr" field.
	func (uuo *UserUpdateOne) SetAddr(sa schema.Addr) *UserUpdateOne {
		uuo.mutation.SetAddr(sa)
		return uuo
	}
		...
		// SetNillableAddr sets the "addr" field if the given value is not nil.
		func (uuo *UserUpdateOne) SetNillableAddr(sa *schema.Addr) *UserUpdateOne {
			if sa != nil {
				uuo.SetAddr(*sa)
			}
			return uuo
