...
func (m UserMutation) Tx() (*Tx, error) {
	...
	func (m *UserMutation) SetT(schema.t *schema.T) {
		m.t = &schema.t
	}
	...
	func (m *UserMutation) SetURL(uu *url.URL) {
		m.url = &uu
	}
	...
	func (m *UserMutation) SetURLs(uu []*url.URL) {
		m._URLs = &uu
			m.append_URLs = nil
	}
	...
	func (m *UserMutation) URLs() (r []*url.URL, exists bool) {
		...
		// AppendURLs adds uu to the "URLs" field.
		func (m *UserMutation) AppendURLs(uu []*url.URL) {
			m.append_URLs = append(m.append_URLs, uu...)
		}
	...
	func (m *UserMutation) SetRaw(jrm json.RawMessage) {
		m.raw = &jrm
			m.appendraw = nil
	}
	...
	func (m *UserMutation) Raw() (r json.RawMessage, exists bool) {
		...
		// AppendRaw adds jrm to the "raw" field.
		func (m *UserMutation) AppendRaw(jrm json.RawMessage) {
			m.appendraw = append(m.appendraw, jrm...)
		}
	...
	func (m *UserMutation) SetDirs(hd []http.Dir) {
		m.dirs = &hd
			m.appenddirs = nil
	}
	...
	func (m *UserMutation) Dirs() (r []http.Dir, exists bool) {
		...
		// AppendDirs adds hd to the "dirs" field.
		func (m *UserMutation) AppendDirs(hd []http.Dir) {
			m.appenddirs = append(m.appenddirs, hd...)
		}
	...
	func (m *UserMutation) SetAddr(sa schema.Addr) {
		m.addr = &sa
	}
