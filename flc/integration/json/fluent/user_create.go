...
type UserCreate struct {
	...
	func (uc *UserCreate) SetT(schema.t *schema.T) *UserCreate {
		uc.mutation.SetT(schema.t)
		return uc
	}
	...
	func (uc *UserCreate) SetURL(uu *url.URL) *UserCreate {
		uc.mutation.SetURL(uu)
		return uc
	}
	...
	func (uc *UserCreate) SetURLs(uu []*url.URL) *UserCreate {
		uc.mutation.SetURLs(uu)
		return uc
	}
	...
	func (uc *UserCreate) SetRaw(jrm json.RawMessage) *UserCreate {
		uc.mutation.SetRaw(jrm)
		return uc
	}
	...
	func (uc *UserCreate) SetDirs(hd []http.Dir) *UserCreate {
		uc.mutation.SetDirs(hd)
		return uc
	}
	...
	func (uc *UserCreate) SetAddr(sa schema.Addr) *UserCreate {
		uc.mutation.SetAddr(sa)
		return uc
	}
		...
		func (uc *UserCreate) SetNillableAddr(sa *schema.Addr) *UserCreate {
			if sa != nil {
				uc.SetAddr(*sa)
			}
			return uc
