...
import (
	...
	"github.com/usalko/fluent/flc/integration/privacy/fluent/migrate"
...
func (c *TeamClient) mutate(ctx context.Context, m *TeamMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Team mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Task, Team, User []fluent.Hook
	}
	inters struct {
		Task, Team, User []fluent.Interceptor
	}
)
