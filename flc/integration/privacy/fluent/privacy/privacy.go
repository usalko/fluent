...
type TaskQueryRuleFunc func(context.Context, *fluent.TaskQuery) error

// EvalQuery return f(ctx, q).
func (f TaskQueryRuleFunc) EvalQuery(ctx context.Context, q fluent.Query) error {
...
type TaskMutationRuleFunc func(context.Context, *fluent.TaskMutation) error

// EvalMutation calls f(ctx, m).
func (f TaskMutationRuleFunc) EvalMutation(ctx context.Context, m fluent.Mutation) error {
...
// functions as a query rule.
type TeamQueryRuleFunc func(context.Context, *fluent.TeamQuery) error

// EvalQuery return f(ctx, q).
func (f TeamQueryRuleFunc) EvalQuery(ctx context.Context, q fluent.Query) error {
...
// functions as a mutation rule.
type TeamMutationRuleFunc func(context.Context, *fluent.TeamMutation) error

// EvalMutation calls f(ctx, m).
func (f TeamMutationRuleFunc) EvalMutation(ctx context.Context, m fluent.Mutation) error {
...
func queryFilter(q fluent.Query) (Filter, error) {
	switch q := q.(type) {
	case *fluent.TaskQuery:
		return q.Filter(), nil
	case *fluent.TeamQuery:
		return q.Filter(), nil
...
func mutationFilter(m fluent.Mutation) (Filter, error) {
	switch m := m.(type) {
	case *fluent.TaskMutation:
		return m.Filter(), nil
	case *fluent.TeamMutation:
		return m.Filter(), nil
