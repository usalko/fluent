...
func (pq *PCQuery) Order(o ...p_c.OrderOption) *PCQuery {
...
func (pq *PCQuery) First(ctx context.Context) (*PC, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{p_c.Label}
	}
	return nodes[0], nil
}
...
func (pq *PCQuery) Only(ctx context.Context) (*PC, error) {
	...
	case 0:
		return nil, &NotFoundError{p_c.Label}
	default:
		return nil, &NotSingularError{p_c.Label}
	}
}
...
func (pq *PCQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{p_c.Label}
	default:
		err = &NotSingularError{p_c.Label}
	}
	return
}
...
func (pq *PCQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = pq.Select(p_c.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (pq *PCQuery) Clone() *PCQuery {
	...
	return &PCQuery{
		config:     pq.config,
		ctx:        pq.ctx.Clone(),
		order:      append([]p_c.OrderOption{}, pq.order...),
...
func (pq *PCQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(p_c.Table, p_c.Columns, sqlgraph.NewFieldSpec(p_c.FieldID, field.TypeInt))
	_spec.From = pq.sql
	...
	if fields := pq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, p_c.FieldID)
		for i := range fields {
			if fields[i] != p_c.FieldID {
