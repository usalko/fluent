...
func (*GroupInfo) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group_info.FieldID, group_info.FieldMaxUsers:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the GroupInfo.
// This includes values selected through modifiers, order, etc.
func (gi *GroupInfo) Value(name string) (fluent.Value, error) {
