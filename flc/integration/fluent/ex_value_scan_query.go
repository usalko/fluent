...
type ExValueScanQuery struct {
	config
	ctx        *QueryContext
	order      []ex_value_scan.OrderOption
	inters     []Interceptor
...
func (evsq *ExValueScanQuery) Order(o ...ex_value_scan.OrderOption) *ExValueScanQuery {
...
func (evsq *ExValueScanQuery) First(ctx context.Context) (*ExValueScan, error) {
	nodes, err := evsq.Limit(1).All(setContextOp(ctx, evsq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{ex_value_scan.Label}
	}
	return nodes[0], nil
}
...
func (evsq *ExValueScanQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = evsq.Limit(1).IDs(setContextOp(ctx, evsq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (evsq *ExValueScanQuery) Only(ctx context.Context) (*ExValueScan, error) {
	nodes, err := evsq.Limit(2).All(setContextOp(ctx, evsq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{ex_value_scan.Label}
	default:
		return nil, &NotSingularError{ex_value_scan.Label}
	}
}
...
func (evsq *ExValueScanQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = evsq.Limit(2).IDs(setContextOp(ctx, evsq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{ex_value_scan.Label}
	default:
		err = &NotSingularError{ex_value_scan.Label}
	}
	return
}
...
func (evsq *ExValueScanQuery) All(ctx context.Context) ([]*ExValueScan, error) {
	ctx = setContextOp(ctx, evsq.ctx, fluent.OpQueryAll)
...
func (evsq *ExValueScanQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, evsq.ctx, fluent.OpQueryIDs)
	if err = evsq.Select(ex_value_scan.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (evsq *ExValueScanQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, evsq.ctx, fluent.OpQueryCount)
	if err := evsq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (evsq *ExValueScanQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, evsq.ctx, fluent.OpQueryExist)
...
func (evsq *ExValueScanQuery) Clone() *ExValueScanQuery {
	...
	return &ExValueScanQuery{
		config:     evsq.config,
		ctx:        evsq.ctx.Clone(),
		order:      append([]ex_value_scan.OrderOption{}, evsq.order...),
...
//		GroupBy(ex_value_scan.FieldBinary).
...
func (evsq *ExValueScanQuery) GroupBy(field string, fields ...string) *ExValueScanGroupBy {
	...
	grbuild.label = ex_value_scan.Label
...
//
//	client.ExValueScan.Query().
//		Select(ex_value_scan.FieldBinary).
//		Scan(ctx, &v)
func (evsq *ExValueScanQuery) Select(fields ...string) *ExValueScanSelect {
	...
	sbuild.label = ex_value_scan.Label
...
func (evsq *ExValueScanQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(ex_value_scan.Table, ex_value_scan.Columns, sqlgraph.NewFieldSpec(ex_value_scan.FieldID, field.TypeInt))
	_spec.From = evsq.sql
	...
	if fields := evsq.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != ex_value_scan.FieldID {
...
func (evsq *ExValueScanQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(ex_value_scan.Table)
...
func (evsgb *ExValueScanGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, evsgb.build.ctx, fluent.OpQueryGroupBy)
...
func (evss *ExValueScanSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, evss.ctx, fluent.OpQuerySelect)
