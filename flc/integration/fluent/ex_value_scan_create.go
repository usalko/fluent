...
func (evsc *ExValueScanCreate) createSpec() (*ExValueScan, *sqlgraph.CreateSpec, error) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(ex_value_scan.Table, sqlgraph.NewFieldSpec(ex_value_scan.FieldID, field.TypeInt))
	)
	_spec.OnConflict = evsc.conflict
	if value, ok := evsc.mutation.Binary(); ok {
		vv, err := ex_value_scan.ValueScanner.Binary.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldBinary, field.TypeString, vv)
		_node.Binary = value
	}
	if value, ok := evsc.mutation.BinaryBytes(); ok {
		vv, err := ex_value_scan.ValueScanner.BinaryBytes.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldBinaryBytes, field.TypeBytes, vv)
		_node.BinaryBytes = value
	}
	if value, ok := evsc.mutation.BinaryOptional(); ok {
		vv, err := ex_value_scan.ValueScanner.BinaryOptional.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldBinaryOptional, field.TypeString, vv)
		_node.BinaryOptional = value
	}
	if value, ok := evsc.mutation.Text(); ok {
		vv, err := ex_value_scan.ValueScanner.Text.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldText, field.TypeString, vv)
		_node.Text = value
	}
	if value, ok := evsc.mutation.TextOptional(); ok {
		vv, err := ex_value_scan.ValueScanner.TextOptional.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldTextOptional, field.TypeString, vv)
		_node.TextOptional = value
	}
	if value, ok := evsc.mutation.Base64(); ok {
		vv, err := ex_value_scan.ValueScanner.Base64.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldBase64, field.TypeString, vv)
		_node.Base64 = value
	}
	if value, ok := evsc.mutation.Custom(); ok {
		vv, err := ex_value_scan.ValueScanner.Custom.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldCustom, field.TypeString, vv)
		_node.Custom = value
	}
	if value, ok := evsc.mutation.CustomOptional(); ok {
		vv, err := ex_value_scan.ValueScanner.CustomOptional.Value(value)
		if err != nil {
			return nil, nil, err
		}
		_spec.SetField(ex_value_scan.FieldCustomOptional, field.TypeString, vv)
...
//		// update values.
//		Update(func(u *fluent.ExValueScanUpsert) {
//			SetBinary(v+v).
//		}).
//		Exec(ctx)
...
func (u *ExValueScanUpsert) SetBinary(v *url.URL) *ExValueScanUpsert {
	u.Set(ex_value_scan.FieldBinary, v)
	return u
}
...
func (u *ExValueScanUpsert) UpdateBinary() *ExValueScanUpsert {
	u.SetExcluded(ex_value_scan.FieldBinary)
	return u
}

// SetBinaryBytes sets the "binary_bytes" field.
func (u *ExValueScanUpsert) SetBinaryBytes(v *url.URL) *ExValueScanUpsert {
	u.Set(ex_value_scan.FieldBinaryBytes, v)
	return u
}
...
func (u *ExValueScanUpsert) UpdateBinaryBytes() *ExValueScanUpsert {
	u.SetExcluded(ex_value_scan.FieldBinaryBytes)
	return u
}

// SetBinaryOptional sets the "binary_optional" field.
func (u *ExValueScanUpsert) SetBinaryOptional(v *url.URL) *ExValueScanUpsert {
	u.Set(ex_value_scan.FieldBinaryOptional, v)
	return u
}
...
func (u *ExValueScanUpsert) UpdateBinaryOptional() *ExValueScanUpsert {
	u.SetExcluded(ex_value_scan.FieldBinaryOptional)
	return u
}
...
func (u *ExValueScanUpsert) UpdateTextOptional() *ExValueScanUpsert {
	u.SetExcluded(ex_value_scan.FieldTextOptional)
	return u
}
...
func (u *ExValueScanUpsert) ClearTextOptional() *ExValueScanUpsert {
	u.SetNull(ex_value_scan.FieldTextOptional)
	return u
}

// SetBase64 sets the "base64" field.
func (u *ExValueScanUpsert) SetBase64(v string) *ExValueScanUpsert {
	u.Set(ex_value_scan.FieldBase64, v)
	return u
}
...
func (u *ExValueScanUpsert) UpdateBase64() *ExValueScanUpsert {
	u.SetExcluded(ex_value_scan.FieldBase64)
	return u
}

// SetCustom sets the "custom" field.
func (u *ExValueScanUpsert) SetCustom(v string) *ExValueScanUpsert {
	u.Set(ex_value_scan.FieldCustom, v)
	return u
}
...
func (u *ExValueScanUpsert) UpdateCustom() *ExValueScanUpsert {
	u.SetExcluded(ex_value_scan.FieldCustom)
	return u
}

// SetCustomOptional sets the "custom_optional" field.
func (u *ExValueScanUpsert) SetCustomOptional(v string) *ExValueScanUpsert {
	u.Set(ex_value_scan.FieldCustomOptional, v)
	return u
}
...
func (u *ExValueScanUpsert) UpdateCustomOptional() *ExValueScanUpsert {
	u.SetExcluded(ex_value_scan.FieldCustomOptional)
	return u
}
...
func (u *ExValueScanUpsert) ClearCustomOptional() *ExValueScanUpsert {
	u.SetNull(ex_value_scan.FieldCustomOptional)
	return u
}
