...
func (ftu *FieldTypeUpdate) SetState(ft field_type.State) *FieldTypeUpdate {
	ftu.mutation.SetState(ft)
	return ftu
}

// SetNillableState sets the "state" field if the given value is not nil.
func (ftu *FieldTypeUpdate) SetNillableState(ft *field_type.State) *FieldTypeUpdate {
	if ft != nil {
		ftu.SetState(*ft)
	}
	return ftu
...
func (ftu *FieldTypeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(field_type.Table, field_type.Columns, sqlgraph.NewFieldSpec(field_type.FieldID, field.TypeInt))
	...
	if value, ok := ftu.mutation.AddedInt(); ok {
		_spec.AddField(field_type.FieldInt, field.TypeInt, value)
	}
	...
	if value, ok := ftu.mutation.AddedInt8(); ok {
		_spec.AddField(field_type.FieldInt8, field.TypeInt8, value)
	}
	...
	if value, ok := ftu.mutation.AddedInt16(); ok {
		_spec.AddField(field_type.FieldInt16, field.TypeInt16, value)
	}
	...
	if value, ok := ftu.mutation.AddedInt32(); ok {
		_spec.AddField(field_type.FieldInt32, field.TypeInt32, value)
	}
	...
	if value, ok := ftu.mutation.AddedInt64(); ok {
		_spec.AddField(field_type.FieldInt64, field.TypeInt64, value)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalInt(); ok {
		_spec.AddField(field_type.FieldOptionalInt, field.TypeInt, value)
	}
	if ftu.mutation.OptionalIntCleared() {
		_spec.ClearField(field_type.FieldOptionalInt, field.TypeInt)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalInt8(); ok {
		_spec.AddField(field_type.FieldOptionalInt8, field.TypeInt8, value)
	}
	if ftu.mutation.OptionalInt8Cleared() {
		_spec.ClearField(field_type.FieldOptionalInt8, field.TypeInt8)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalInt16(); ok {
		_spec.AddField(field_type.FieldOptionalInt16, field.TypeInt16, value)
	}
	if ftu.mutation.OptionalInt16Cleared() {
		_spec.ClearField(field_type.FieldOptionalInt16, field.TypeInt16)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalInt32(); ok {
		_spec.AddField(field_type.FieldOptionalInt32, field.TypeInt32, value)
	}
	if ftu.mutation.OptionalInt32Cleared() {
		_spec.ClearField(field_type.FieldOptionalInt32, field.TypeInt32)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalInt64(); ok {
		_spec.AddField(field_type.FieldOptionalInt64, field.TypeInt64, value)
	}
	if ftu.mutation.OptionalInt64Cleared() {
		_spec.ClearField(field_type.FieldOptionalInt64, field.TypeInt64)
	}
	...
	if value, ok := ftu.mutation.AddedNillableInt(); ok {
		_spec.AddField(field_type.FieldNillableInt, field.TypeInt, value)
	}
	if ftu.mutation.NillableIntCleared() {
		_spec.ClearField(field_type.FieldNillableInt, field.TypeInt)
	}
	...
	if value, ok := ftu.mutation.AddedNillableInt8(); ok {
		_spec.AddField(field_type.FieldNillableInt8, field.TypeInt8, value)
	}
	if ftu.mutation.NillableInt8Cleared() {
		_spec.ClearField(field_type.FieldNillableInt8, field.TypeInt8)
	}
	...
	if value, ok := ftu.mutation.AddedNillableInt16(); ok {
		_spec.AddField(field_type.FieldNillableInt16, field.TypeInt16, value)
	}
	if ftu.mutation.NillableInt16Cleared() {
		_spec.ClearField(field_type.FieldNillableInt16, field.TypeInt16)
	}
	...
	if value, ok := ftu.mutation.AddedNillableInt32(); ok {
		_spec.AddField(field_type.FieldNillableInt32, field.TypeInt32, value)
	}
	if ftu.mutation.NillableInt32Cleared() {
		_spec.ClearField(field_type.FieldNillableInt32, field.TypeInt32)
	}
	...
	if value, ok := ftu.mutation.AddedNillableInt64(); ok {
		_spec.AddField(field_type.FieldNillableInt64, field.TypeInt64, value)
	}
	if ftu.mutation.NillableInt64Cleared() {
		_spec.ClearField(field_type.FieldNillableInt64, field.TypeInt64)
	}
	...
	if value, ok := ftu.mutation.AddedValidateOptionalInt32(); ok {
		_spec.AddField(field_type.FieldValidateOptionalInt32, field.TypeInt32, value)
	}
	if ftu.mutation.ValidateOptionalInt32Cleared() {
		_spec.ClearField(field_type.FieldValidateOptionalInt32, field.TypeInt32)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalUint(); ok {
		_spec.AddField(field_type.FieldOptionalUint, field.TypeUint, value)
	}
	if ftu.mutation.OptionalUintCleared() {
		_spec.ClearField(field_type.FieldOptionalUint, field.TypeUint)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalUint8(); ok {
		_spec.AddField(field_type.FieldOptionalUint8, field.TypeUint8, value)
	}
	if ftu.mutation.OptionalUint8Cleared() {
		_spec.ClearField(field_type.FieldOptionalUint8, field.TypeUint8)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalUint16(); ok {
		_spec.AddField(field_type.FieldOptionalUint16, field.TypeUint16, value)
	}
	if ftu.mutation.OptionalUint16Cleared() {
		_spec.ClearField(field_type.FieldOptionalUint16, field.TypeUint16)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalUint32(); ok {
		_spec.AddField(field_type.FieldOptionalUint32, field.TypeUint32, value)
	}
	if ftu.mutation.OptionalUint32Cleared() {
		_spec.ClearField(field_type.FieldOptionalUint32, field.TypeUint32)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalUint64(); ok {
		_spec.AddField(field_type.FieldOptionalUint64, field.TypeUint64, value)
	}
	if ftu.mutation.OptionalUint64Cleared() {
		_spec.ClearField(field_type.FieldOptionalUint64, field.TypeUint64)
	}
	if value, ok := ftu.mutation.State(); ok {
		_spec.SetField(field_type.FieldState, field.TypeEnum, value)
	}
	if ftu.mutation.StateCleared() {
		_spec.ClearField(field_type.FieldState, field.TypeEnum)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalFloat(); ok {
		_spec.AddField(field_type.FieldOptionalFloat, field.TypeFloat64, value)
	}
	if ftu.mutation.OptionalFloatCleared() {
		_spec.ClearField(field_type.FieldOptionalFloat, field.TypeFloat64)
	}
	...
	if value, ok := ftu.mutation.AddedOptionalFloat32(); ok {
		_spec.AddField(field_type.FieldOptionalFloat32, field.TypeFloat32, value)
	}
	if ftu.mutation.OptionalFloat32Cleared() {
		_spec.ClearField(field_type.FieldOptionalFloat32, field.TypeFloat32)
	}
	if value, ok := ftu.mutation.Text(); ok {
		_spec.SetField(field_type.FieldText, field.TypeString, value)
	}
	if ftu.mutation.TextCleared() {
		_spec.ClearField(field_type.FieldText, field.TypeString)
	}
	...
	if ftu.mutation.DatetimeCleared() {
		_spec.ClearField(field_type.FieldDatetime, field.TypeTime)
	}
	...
	if value, ok := ftu.mutation.AddedDecimal(); ok {
		_spec.AddField(field_type.FieldDecimal, field.TypeFloat64, value)
	}
	if ftu.mutation.DecimalCleared() {
		_spec.ClearField(field_type.FieldDecimal, field.TypeFloat64)
	}
	...
	if ftu.mutation.LinkOtherCleared() {
		_spec.ClearField(field_type.FieldLinkOther, field.TypeOther)
	}
	...
	if ftu.mutation.LinkOtherFuncCleared() {
		_spec.ClearField(field_type.FieldLinkOtherFunc, field.TypeOther)
	}
	if value, ok := ftu.mutation.MAC(); ok {
		_spec.SetField(field_type.FieldMAC, field.TypeString, value)
	}
	if ftu.mutation.MACCleared() {
		_spec.ClearField(field_type.FieldMAC, field.TypeString)
	}
	...
	if ftu.mutation.StringArrayCleared() {
		_spec.ClearField(field_type.FieldStringArray, field.TypeOther)
	}
	...
	if ftu.mutation.PasswordCleared() {
		_spec.ClearField(field_type.FieldPassword, field.TypeString)
	}
	...
	if ftu.mutation.StringScannerCleared() {
		_spec.ClearField(field_type.FieldStringScanner, field.TypeString)
	}
	...
	if value, ok := ftu.mutation.AddedDuration(); ok {
		_spec.AddField(field_type.FieldDuration, field.TypeInt64, value)
	}
	if ftu.mutation.DurationCleared() {
		_spec.ClearField(field_type.FieldDuration, field.TypeInt64)
	}
	...
	if ftu.mutation.NullLinkCleared() {
		_spec.ClearField(field_type.FieldNullLink, field.TypeString)
	}
	...
	if ftu.mutation.ActiveCleared() {
		_spec.ClearField(field_type.FieldActive, field.TypeBool)
	}
	...
	if ftu.mutation.NullActiveCleared() {
		_spec.ClearField(field_type.FieldNullActive, field.TypeBool)
	}
	...
	if ftu.mutation.DeletedCleared() {
		_spec.ClearField(field_type.FieldDeleted, field.TypeBool)
	}
	...
	if ftu.mutation.DeletedAtCleared() {
		_spec.ClearField(field_type.FieldDeletedAt, field.TypeTime)
	}
	...
	if ftu.mutation.RawDataCleared() {
		_spec.ClearField(field_type.FieldRawData, field.TypeBytes)
	}
	...
	if ftu.mutation.NullInt64Cleared() {
		_spec.ClearField(field_type.FieldNullInt64, field.TypeInt)
	}
	...
	if value, ok := ftu.mutation.AddedSchemaInt(); ok {
		_spec.AddField(field_type.FieldSchemaInt, field.TypeInt, value)
	}
	if ftu.mutation.SchemaIntCleared() {
		_spec.ClearField(field_type.FieldSchemaInt, field.TypeInt)
	}
	...
	if value, ok := ftu.mutation.AddedSchemaInt8(); ok {
		_spec.AddField(field_type.FieldSchemaInt8, field.TypeInt8, value)
	}
	if ftu.mutation.SchemaInt8Cleared() {
		_spec.ClearField(field_type.FieldSchemaInt8, field.TypeInt8)
	}
	...
	if value, ok := ftu.mutation.AddedSchemaInt64(); ok {
		_spec.AddField(field_type.FieldSchemaInt64, field.TypeInt64, value)
	}
	if ftu.mutation.SchemaInt64Cleared() {
		_spec.ClearField(field_type.FieldSchemaInt64, field.TypeInt64)
	}
	...
	if value, ok := ftu.mutation.AddedSchemaFloat(); ok {
		_spec.AddField(field_type.FieldSchemaFloat, field.TypeFloat64, value)
	}
	if ftu.mutation.SchemaFloatCleared() {
		_spec.ClearField(field_type.FieldSchemaFloat, field.TypeFloat64)
	}
	...
	if value, ok := ftu.mutation.AddedSchemaFloat32(); ok {
		_spec.AddField(field_type.FieldSchemaFloat32, field.TypeFloat32, value)
	}
	if ftu.mutation.SchemaFloat32Cleared() {
		_spec.ClearField(field_type.FieldSchemaFloat32, field.TypeFloat32)
	}
	...
	if ftu.mutation.NullFloatCleared() {
		_spec.ClearField(field_type.FieldNullFloat, field.TypeFloat64)
	}
	...
	if ftu.mutation.PriorityCleared() {
		_spec.ClearField(field_type.FieldPriority, field.TypeEnum)
	}
	...
	if ftu.mutation.OptionalUUIDCleared() {
		_spec.ClearField(field_type.FieldOptionalUUID, field.TypeUUID)
	}
	...
	if ftu.mutation.NillableUUIDCleared() {
		_spec.ClearField(field_type.FieldNillableUUID, field.TypeUUID)
	}
	...
	if value, ok := ftu.mutation.AppendedStrings(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, field_type.FieldStrings, value)
		})
	}
	if ftu.mutation.StringsCleared() {
		_spec.ClearField(field_type.FieldStrings, field.TypeJSON)
	}
	...
	if ftu.mutation.NilPairCleared() {
		_spec.ClearField(field_type.FieldNilPair, field.TypeBytes)
	}
	...
	if value, ok := ftu.mutation.AddedBigInt(); ok {
		_spec.AddField(field_type.FieldBigInt, field.TypeInt, value)
	}
	if ftu.mutation.BigIntCleared() {
		_spec.ClearField(field_type.FieldBigInt, field.TypeInt)
	}
...
// SetState sets the "state" field.
func (ftuo *FieldTypeUpdateOne) SetState(ft field_type.State) *FieldTypeUpdateOne {
	ftuo.mutation.SetState(ft)
	return ftuo
}

// SetNillableState sets the "state" field if the given value is not nil.
func (ftuo *FieldTypeUpdateOne) SetNillableState(ft *field_type.State) *FieldTypeUpdateOne {
	if ft != nil {
		ftuo.SetState(*ft)
	}
	return ftuo
...
func (ftuo *FieldTypeUpdateOne) sqlSave(ctx context.Context) (_node *FieldType, err error) {
	...
	if fields := ftuo.fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, field_type.FieldID)
		for _, f := range fields {
			if !field_type.ValidColumn(f) {
				return nil, &ValidationError{Name: f, err: fmt.Errorf("fluent: invalid field %q for query", f)}
			}
			if f != field_type.FieldID {
