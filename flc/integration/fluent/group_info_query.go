...
func (giq *GroupInfoQuery) Order(o ...group_info.OrderOption) *GroupInfoQuery {
...
func (giq *GroupInfoQuery) QueryGroups() *GroupQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(group_info.Table, group_info.FieldID, selector),
...
func (giq *GroupInfoQuery) First(ctx context.Context) (*GroupInfo, error) {
	nodes, err := giq.Limit(1).All(setContextOp(ctx, giq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{group_info.Label}
	}
	return nodes[0], nil
}
...
func (giq *GroupInfoQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = giq.Limit(1).IDs(setContextOp(ctx, giq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{group_info.Label}
		return
	}
	return ids[0], nil
}
...
func (giq *GroupInfoQuery) Only(ctx context.Context) (*GroupInfo, error) {
	nodes, err := giq.Limit(2).All(setContextOp(ctx, giq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{group_info.Label}
	default:
		return nil, &NotSingularError{group_info.Label}
	}
}
...
func (giq *GroupInfoQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = giq.Limit(2).IDs(setContextOp(ctx, giq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{group_info.Label}
	default:
		err = &NotSingularError{group_info.Label}
	}
	return
}
...
func (giq *GroupInfoQuery) All(ctx context.Context) ([]*GroupInfo, error) {
	ctx = setContextOp(ctx, giq.ctx, fluent.OpQueryAll)
	if err := giq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (giq *GroupInfoQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, giq.ctx, fluent.OpQueryIDs)
	if err = giq.Select(group_info.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (giq *GroupInfoQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, giq.ctx, fluent.OpQueryCount)
	if err := giq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (giq *GroupInfoQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, giq.ctx, fluent.OpQueryExist)
...
func (giq *GroupInfoQuery) Clone() *GroupInfoQuery {
	...
	return &GroupInfoQuery{
		config:     giq.config,
		ctx:        giq.ctx.Clone(),
		order:      append([]group_info.OrderOption{}, giq.order...),
...
func (giq *GroupInfoQuery) GroupBy(field string, fields ...string) *GroupInfoGroupBy {
	...
	grbuild.label = group_info.Label
...
func (giq *GroupInfoQuery) loadGroups(ctx context.Context, query *GroupQuery, nodes []*GroupInfo, init func(*GroupInfo), assign func(*GroupInfo, *Group)) error {
	...
	query.Where(predicate.Group(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(group_info.GroupsColumn), fks...))
	}))
...
func (giq *GroupInfoQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(group_info.Table, group_info.Columns, sqlgraph.NewFieldSpec(group_info.FieldID, field.TypeInt))
	_spec.From = giq.sql
	...
	if fields := giq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, group_info.FieldID)
		for i := range fields {
			if fields[i] != group_info.FieldID {
...
func (giq *GroupInfoQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(group_info.Table)
...
func (gigb *GroupInfoGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, gigb.build.ctx, fluent.OpQueryGroupBy)
...
func (gis *GroupInfoSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, gis.ctx, fluent.OpQuerySelect)
