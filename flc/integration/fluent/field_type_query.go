...
func (ftq *FieldTypeQuery) Order(o ...field_type.OrderOption) *FieldTypeQuery {
...
func (ftq *FieldTypeQuery) First(ctx context.Context) (*FieldType, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{field_type.Label}
	}
	return nodes[0], nil
}
...
func (ftq *FieldTypeQuery) Only(ctx context.Context) (*FieldType, error) {
	...
	case 0:
		return nil, &NotFoundError{field_type.Label}
	default:
		return nil, &NotSingularError{field_type.Label}
	}
}
...
func (ftq *FieldTypeQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{field_type.Label}
	default:
		err = &NotSingularError{field_type.Label}
	}
	return
}
...
func (ftq *FieldTypeQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = ftq.Select(field_type.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (ftq *FieldTypeQuery) Clone() *FieldTypeQuery {
	...
	return &FieldTypeQuery{
		config:     ftq.config,
		ctx:        ftq.ctx.Clone(),
		order:      append([]field_type.OrderOption{}, ftq.order...),
...
func (ftq *FieldTypeQuery) GroupBy(field string, fields ...string) *FieldTypeGroupBy {
	...
	grbuild.label = field_type.Label
...
func (ftq *FieldTypeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*FieldType, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, field_type.ForeignKeys...)
	}
...
func (ftq *FieldTypeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(field_type.Table, field_type.Columns, sqlgraph.NewFieldSpec(field_type.FieldID, field.TypeInt))
	_spec.From = ftq.sql
	...
	if fields := ftq.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != field_type.FieldID {
...
func (ftq *FieldTypeQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(field_type.Table)
