...
func (ftq *FileTypeQuery) Order(o ...file_type.OrderOption) *FileTypeQuery {
...
func (ftq *FileTypeQuery) QueryFiles() *FileQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(file_type.Table, file_type.FieldID, selector),
...
func (ftq *FileTypeQuery) First(ctx context.Context) (*FileType, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{file_type.Label}
	}
	return nodes[0], nil
}
...
func (ftq *FileTypeQuery) FirstID(ctx context.Context) (id int, err error) {
	...
	if len(ids) == 0 {
		err = &NotFoundError{file_type.Label}
		return
	}
	return ids[0], nil
}
...
func (ftq *FileTypeQuery) Only(ctx context.Context) (*FileType, error) {
	...
	case 0:
		return nil, &NotFoundError{file_type.Label}
	default:
		return nil, &NotSingularError{file_type.Label}
	}
}
...
func (ftq *FileTypeQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{file_type.Label}
	default:
		err = &NotSingularError{file_type.Label}
	}
	return
}
...
func (ftq *FileTypeQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = ftq.Select(file_type.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (ftq *FileTypeQuery) Clone() *FileTypeQuery {
	...
	return &FileTypeQuery{
		config:     ftq.config,
		ctx:        ftq.ctx.Clone(),
		order:      append([]file_type.OrderOption{}, ftq.order...),
...
func (ftq *FileTypeQuery) loadFiles(ctx context.Context, query *FileQuery, nodes []*FileType, init func(*FileType), assign func(*FileType, *File)) error {
	...
	query.Where(predicate.File(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(file_type.FilesColumn), fks...))
	}))
...
func (ftq *FileTypeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(file_type.Table, file_type.Columns, sqlgraph.NewFieldSpec(file_type.FieldID, field.TypeInt))
	_spec.From = ftq.sql
	...
	if fields := ftq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, file_type.FieldID)
		for i := range fields {
			if fields[i] != file_type.FieldID {
...
func (ftq *FileTypeQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(file_type.Table)
