...
func (ftc *FileTypeCreate) SetType(file_type_type file_type.Type) *FileTypeCreate {
	ftc.mutation.SetType(file_type_type)
	return ftc
}

// SetNillableType sets the "type" field if the given value is not nil.
func (ftc *FileTypeCreate) SetNillableType(file_type_type *file_type.Type) *FileTypeCreate {
	if file_type_type != nil {
		ftc.SetType(*file_type_type)
	}
	return ftc
}

// SetState sets the "state" field.
func (ftc *FileTypeCreate) SetState(file_type_state file_type.State) *FileTypeCreate {
	ftc.mutation.SetState(file_type_state)
	return ftc
}

// SetNillableState sets the "state" field if the given value is not nil.
func (ftc *FileTypeCreate) SetNillableState(file_type_state *file_type.State) *FileTypeCreate {
	if file_type_state != nil {
		ftc.SetState(*file_type_state)
	}
	return ftc
}
...
func (ftc *FileTypeCreate) createSpec() (*FileType, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(file_type.Table, sqlgraph.NewFieldSpec(file_type.FieldID, field.TypeInt))
	)
	_spec.OnConflict = ftc.conflict
	if value, ok := ftc.mutation.Name(); ok {
		_spec.SetField(file_type.FieldName, field.TypeString, value)
		_node.Name = value
	}
	if value, ok := ftc.mutation.GetType(); ok {
		_spec.SetField(file_type.FieldType, field.TypeEnum, value)
		_node.Type = value
	}
	if value, ok := ftc.mutation.State(); ok {
		_spec.SetField(file_type.FieldState, field.TypeEnum, value)
		_node.State = value
	}
...
//		// update values.
//		Update(func(u *fluent.FileTypeUpsert) {
//			SetName(v+v).
//		}).
//		Exec(ctx)
...
func (u *FileTypeUpsert) SetName(v string) *FileTypeUpsert {
	u.Set(file_type.FieldName, v)
	return u
}

// UpdateName sets the "name" field to the value that was provided on create.
func (u *FileTypeUpsert) UpdateName() *FileTypeUpsert {
	u.SetExcluded(file_type.FieldName)
	return u
}

// SetType sets the "type" field.
func (u *FileTypeUpsert) SetType(v file_type.Type) *FileTypeUpsert {
	u.Set(file_type.FieldType, v)
	return u
}

// UpdateType sets the "type" field to the value that was provided on create.
func (u *FileTypeUpsert) UpdateType() *FileTypeUpsert {
	u.SetExcluded(file_type.FieldType)
	return u
}

// SetState sets the "state" field.
func (u *FileTypeUpsert) SetState(v file_type.State) *FileTypeUpsert {
	u.Set(file_type.FieldState, v)
	return u
}

// UpdateState sets the "state" field to the value that was provided on create.
func (u *FileTypeUpsert) UpdateState() *FileTypeUpsert {
	u.SetExcluded(file_type.FieldState)
	return u
}
...
// SetType sets the "type" field.
func (u *FileTypeUpsertOne) SetType(v file_type.Type) *FileTypeUpsertOne {
	return u.Update(func(s *FileTypeUpsert) {
		s.SetType(v)
	})
}
...
// SetState sets the "state" field.
func (u *FileTypeUpsertOne) SetState(v file_type.State) *FileTypeUpsertOne {
	return u.Update(func(s *FileTypeUpsert) {
		s.SetState(v)
	})
}
...
func (u *FileTypeUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("fluent: missing options for FileTypeCreate.OnConflict")
	}
...
// SetType sets the "type" field.
func (u *FileTypeUpsertBulk) SetType(v file_type.Type) *FileTypeUpsertBulk {
	return u.Update(func(s *FileTypeUpsert) {
		s.SetType(v)
	})
}
...
// SetState sets the "state" field.
func (u *FileTypeUpsertBulk) SetState(v file_type.State) *FileTypeUpsertBulk {
	return u.Update(func(s *FileTypeUpsert) {
		s.SetState(v)
	})
}
...
func (u *FileTypeUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("fluent: OnConflict was set for builder %d. Set it on the FileTypeCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("fluent: missing options for FileTypeCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
