...
func (ftc *FieldTypeCreate) SetState(ft field_type.State) *FieldTypeCreate {
	ftc.mutation.SetState(ft)
	return ftc
}

// SetNillableState sets the "state" field if the given value is not nil.
func (ftc *FieldTypeCreate) SetNillableState(ft *field_type.State) *FieldTypeCreate {
	if ft != nil {
		ftc.SetState(*ft)
	}
	return ftc
...
func (ftc *FieldTypeCreate) createSpec() (*FieldType, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(field_type.Table, sqlgraph.NewFieldSpec(field_type.FieldID, field.TypeInt))
	)
	_spec.OnConflict = ftc.conflict
	if value, ok := ftc.mutation.Int(); ok {
		_spec.SetField(field_type.FieldInt, field.TypeInt, value)
		_node.Int = value
	}
	if value, ok := ftc.mutation.Int8(); ok {
		_spec.SetField(field_type.FieldInt8, field.TypeInt8, value)
		_node.Int8 = value
	}
	if value, ok := ftc.mutation.Int16(); ok {
		_spec.SetField(field_type.FieldInt16, field.TypeInt16, value)
		_node.Int16 = value
	}
	if value, ok := ftc.mutation.Int32(); ok {
		_spec.SetField(field_type.FieldInt32, field.TypeInt32, value)
		_node.Int32 = value
	}
	if value, ok := ftc.mutation.Int64(); ok {
		_spec.SetField(field_type.FieldInt64, field.TypeInt64, value)
		_node.Int64 = value
	}
	if value, ok := ftc.mutation.OptionalInt(); ok {
		_spec.SetField(field_type.FieldOptionalInt, field.TypeInt, value)
		_node.OptionalInt = value
	}
	if value, ok := ftc.mutation.OptionalInt8(); ok {
		_spec.SetField(field_type.FieldOptionalInt8, field.TypeInt8, value)
		_node.OptionalInt8 = value
	}
	if value, ok := ftc.mutation.OptionalInt16(); ok {
		_spec.SetField(field_type.FieldOptionalInt16, field.TypeInt16, value)
		_node.OptionalInt16 = value
	}
	if value, ok := ftc.mutation.OptionalInt32(); ok {
		_spec.SetField(field_type.FieldOptionalInt32, field.TypeInt32, value)
		_node.OptionalInt32 = value
	}
	if value, ok := ftc.mutation.OptionalInt64(); ok {
		_spec.SetField(field_type.FieldOptionalInt64, field.TypeInt64, value)
		_node.OptionalInt64 = value
	}
	if value, ok := ftc.mutation.NillableInt(); ok {
		_spec.SetField(field_type.FieldNillableInt, field.TypeInt, value)
		_node.NillableInt = &value
	}
	if value, ok := ftc.mutation.NillableInt8(); ok {
		_spec.SetField(field_type.FieldNillableInt8, field.TypeInt8, value)
		_node.NillableInt8 = &value
	}
	if value, ok := ftc.mutation.NillableInt16(); ok {
		_spec.SetField(field_type.FieldNillableInt16, field.TypeInt16, value)
		_node.NillableInt16 = &value
	}
	if value, ok := ftc.mutation.NillableInt32(); ok {
		_spec.SetField(field_type.FieldNillableInt32, field.TypeInt32, value)
		_node.NillableInt32 = &value
	}
	if value, ok := ftc.mutation.NillableInt64(); ok {
		_spec.SetField(field_type.FieldNillableInt64, field.TypeInt64, value)
		_node.NillableInt64 = &value
	}
	if value, ok := ftc.mutation.ValidateOptionalInt32(); ok {
		_spec.SetField(field_type.FieldValidateOptionalInt32, field.TypeInt32, value)
		_node.ValidateOptionalInt32 = value
	}
	if value, ok := ftc.mutation.OptionalUint(); ok {
		_spec.SetField(field_type.FieldOptionalUint, field.TypeUint, value)
		_node.OptionalUint = value
	}
	if value, ok := ftc.mutation.OptionalUint8(); ok {
		_spec.SetField(field_type.FieldOptionalUint8, field.TypeUint8, value)
		_node.OptionalUint8 = value
	}
	if value, ok := ftc.mutation.OptionalUint16(); ok {
		_spec.SetField(field_type.FieldOptionalUint16, field.TypeUint16, value)
		_node.OptionalUint16 = value
	}
	if value, ok := ftc.mutation.OptionalUint32(); ok {
		_spec.SetField(field_type.FieldOptionalUint32, field.TypeUint32, value)
		_node.OptionalUint32 = value
	}
	if value, ok := ftc.mutation.OptionalUint64(); ok {
		_spec.SetField(field_type.FieldOptionalUint64, field.TypeUint64, value)
		_node.OptionalUint64 = value
	}
	if value, ok := ftc.mutation.State(); ok {
		_spec.SetField(field_type.FieldState, field.TypeEnum, value)
		_node.State = value
	}
	if value, ok := ftc.mutation.OptionalFloat(); ok {
		_spec.SetField(field_type.FieldOptionalFloat, field.TypeFloat64, value)
		_node.OptionalFloat = value
	}
	if value, ok := ftc.mutation.OptionalFloat32(); ok {
		_spec.SetField(field_type.FieldOptionalFloat32, field.TypeFloat32, value)
		_node.OptionalFloat32 = value
	}
	if value, ok := ftc.mutation.Text(); ok {
		_spec.SetField(field_type.FieldText, field.TypeString, value)
		_node.Text = value
	}
	if value, ok := ftc.mutation.Datetime(); ok {
		_spec.SetField(field_type.FieldDatetime, field.TypeTime, value)
		_node.Datetime = value
	}
	if value, ok := ftc.mutation.Decimal(); ok {
		_spec.SetField(field_type.FieldDecimal, field.TypeFloat64, value)
		_node.Decimal = value
	}
	if value, ok := ftc.mutation.LinkOther(); ok {
		_spec.SetField(field_type.FieldLinkOther, field.TypeOther, value)
		_node.LinkOther = value
	}
	if value, ok := ftc.mutation.LinkOtherFunc(); ok {
		_spec.SetField(field_type.FieldLinkOtherFunc, field.TypeOther, value)
		_node.LinkOtherFunc = value
	}
	if value, ok := ftc.mutation.MAC(); ok {
		_spec.SetField(field_type.FieldMAC, field.TypeString, value)
		_node.MAC = value
	}
	if value, ok := ftc.mutation.StringArray(); ok {
		_spec.SetField(field_type.FieldStringArray, field.TypeOther, value)
		_node.StringArray = value
	}
	if value, ok := ftc.mutation.Password(); ok {
		_spec.SetField(field_type.FieldPassword, field.TypeString, value)
		_node.Password = value
	}
	if value, ok := ftc.mutation.StringScanner(); ok {
		_spec.SetField(field_type.FieldStringScanner, field.TypeString, value)
		_node.StringScanner = &value
	}
	if value, ok := ftc.mutation.Duration(); ok {
		_spec.SetField(field_type.FieldDuration, field.TypeInt64, value)
		_node.Duration = value
	}
	if value, ok := ftc.mutation.Dir(); ok {
		_spec.SetField(field_type.FieldDir, field.TypeString, value)
		_node.Dir = value
	}
	if value, ok := ftc.mutation.Ndir(); ok {
		_spec.SetField(field_type.FieldNdir, field.TypeString, value)
		_node.Ndir = &value
	}
	if value, ok := ftc.mutation.Str(); ok {
		_spec.SetField(field_type.FieldStr, field.TypeString, value)
		_node.Str = value
	}
	if value, ok := ftc.mutation.NullStr(); ok {
		_spec.SetField(field_type.FieldNullStr, field.TypeString, value)
		_node.NullStr = value
	}
	if value, ok := ftc.mutation.Link(); ok {
		_spec.SetField(field_type.FieldLink, field.TypeString, value)
		_node.Link = value
	}
	if value, ok := ftc.mutation.NullLink(); ok {
		_spec.SetField(field_type.FieldNullLink, field.TypeString, value)
		_node.NullLink = value
	}
	if value, ok := ftc.mutation.Active(); ok {
		_spec.SetField(field_type.FieldActive, field.TypeBool, value)
		_node.Active = value
	}
	if value, ok := ftc.mutation.NullActive(); ok {
		_spec.SetField(field_type.FieldNullActive, field.TypeBool, value)
		_node.NullActive = &value
	}
	if value, ok := ftc.mutation.Deleted(); ok {
		_spec.SetField(field_type.FieldDeleted, field.TypeBool, value)
		_node.Deleted = value
	}
	if value, ok := ftc.mutation.DeletedAt(); ok {
		_spec.SetField(field_type.FieldDeletedAt, field.TypeTime, value)
		_node.DeletedAt = value
	}
	if value, ok := ftc.mutation.RawData(); ok {
		_spec.SetField(field_type.FieldRawData, field.TypeBytes, value)
		_node.RawData = value
	}
	if value, ok := ftc.mutation.Sensitive(); ok {
		_spec.SetField(field_type.FieldSensitive, field.TypeBytes, value)
		_node.Sensitive = value
	}
	if value, ok := ftc.mutation.IP(); ok {
		_spec.SetField(field_type.FieldIP, field.TypeBytes, value)
		_node.IP = value
	}
	if value, ok := ftc.mutation.NullInt64(); ok {
		_spec.SetField(field_type.FieldNullInt64, field.TypeInt, value)
		_node.NullInt64 = value
	}
	if value, ok := ftc.mutation.SchemaInt(); ok {
		_spec.SetField(field_type.FieldSchemaInt, field.TypeInt, value)
		_node.SchemaInt = value
	}
	if value, ok := ftc.mutation.SchemaInt8(); ok {
		_spec.SetField(field_type.FieldSchemaInt8, field.TypeInt8, value)
		_node.SchemaInt8 = value
	}
	if value, ok := ftc.mutation.SchemaInt64(); ok {
		_spec.SetField(field_type.FieldSchemaInt64, field.TypeInt64, value)
		_node.SchemaInt64 = value
	}
	if value, ok := ftc.mutation.SchemaFloat(); ok {
		_spec.SetField(field_type.FieldSchemaFloat, field.TypeFloat64, value)
		_node.SchemaFloat = value
	}
	if value, ok := ftc.mutation.SchemaFloat32(); ok {
		_spec.SetField(field_type.FieldSchemaFloat32, field.TypeFloat32, value)
		_node.SchemaFloat32 = value
	}
	if value, ok := ftc.mutation.NullFloat(); ok {
		_spec.SetField(field_type.FieldNullFloat, field.TypeFloat64, value)
		_node.NullFloat = value
	}
	if value, ok := ftc.mutation.Role(); ok {
		_spec.SetField(field_type.FieldRole, field.TypeEnum, value)
		_node.Role = value
	}
	if value, ok := ftc.mutation.Priority(); ok {
		_spec.SetField(field_type.FieldPriority, field.TypeEnum, value)
		_node.Priority = value
	}
	if value, ok := ftc.mutation.OptionalUUID(); ok {
		_spec.SetField(field_type.FieldOptionalUUID, field.TypeUUID, value)
		_node.OptionalUUID = value
	}
	if value, ok := ftc.mutation.NillableUUID(); ok {
		_spec.SetField(field_type.FieldNillableUUID, field.TypeUUID, value)
		_node.NillableUUID = &value
	}
	if value, ok := ftc.mutation.Strings(); ok {
		_spec.SetField(field_type.FieldStrings, field.TypeJSON, value)
		_node.Strings = value
	}
	if value, ok := ftc.mutation.Pair(); ok {
		_spec.SetField(field_type.FieldPair, field.TypeBytes, value)
		_node.Pair = value
	}
	if value, ok := ftc.mutation.NilPair(); ok {
		_spec.SetField(field_type.FieldNilPair, field.TypeBytes, value)
		_node.NilPair = value
	}
	if value, ok := ftc.mutation.Vstring(); ok {
		_spec.SetField(field_type.FieldVstring, field.TypeString, value)
		_node.Vstring = value
	}
	if value, ok := ftc.mutation.Triple(); ok {
		_spec.SetField(field_type.FieldTriple, field.TypeString, value)
		_node.Triple = value
	}
	if value, ok := ftc.mutation.BigInt(); ok {
		_spec.SetField(field_type.FieldBigInt, field.TypeInt, value)
		_node.BigInt = value
	}
	if value, ok := ftc.mutation.PasswordOther(); ok {
		_spec.SetField(field_type.FieldPasswordOther, field.TypeOther, value)
...
//		// update values.
//		Update(func(u *fluent.FieldTypeUpsert) {
//			SetInt(v+v).
//		}).
//		Exec(ctx)
...
func (u *FieldTypeUpsert) UpdateValidateOptionalInt32() *FieldTypeUpsert {
	u.SetExcluded(field_type.FieldValidateOptionalInt32)
	return u
}
...
func (u *FieldTypeUpsert) AddValidateOptionalInt32(v int32) *FieldTypeUpsert {
	u.Add(field_type.FieldValidateOptionalInt32, v)
	return u
}
...
func (u *FieldTypeUpsert) ClearValidateOptionalInt32() *FieldTypeUpsert {
	u.SetNull(field_type.FieldValidateOptionalInt32)
	return u
}

// SetOptionalUint sets the "optional_uint" field.
func (u *FieldTypeUpsert) SetOptionalUint(v uint) *FieldTypeUpsert {
	u.Set(field_type.FieldOptionalUint, v)
	return u
}
...
func (u *FieldTypeUpsert) ClearOptionalUint16() *FieldTypeUpsert {
	u.SetNull(field_type.FieldOptionalUint16)
	return u
}

// SetOptionalUint32 sets the "optional_uint32" field.
func (u *FieldTypeUpsert) SetOptionalUint32(v uint32) *FieldTypeUpsert {
	u.Set(field_type.FieldOptionalUint32, v)
	return u
}
...
func (u *FieldTypeUpsert) ClearOptionalUint32() *FieldTypeUpsert {
	u.SetNull(field_type.FieldOptionalUint32)
	return u
}

// SetOptionalUint64 sets the "optional_uint64" field.
func (u *FieldTypeUpsert) SetOptionalUint64(v uint64) *FieldTypeUpsert {
	u.Set(field_type.FieldOptionalUint64, v)
	return u
}
...
func (u *FieldTypeUpsert) ClearOptionalUint64() *FieldTypeUpsert {
	u.SetNull(field_type.FieldOptionalUint64)
	return u
}

// SetState sets the "state" field.
func (u *FieldTypeUpsert) SetState(v field_type.State) *FieldTypeUpsert {
	u.Set(field_type.FieldState, v)
	return u
}

// UpdateState sets the "state" field to the value that was provided on create.
func (u *FieldTypeUpsert) UpdateState() *FieldTypeUpsert {
	u.SetExcluded(field_type.FieldState)
	return u
}

// ClearState clears the value of the "state" field.
func (u *FieldTypeUpsert) ClearState() *FieldTypeUpsert {
	u.SetNull(field_type.FieldState)
	return u
}

// SetOptionalFloat sets the "optional_float" field.
func (u *FieldTypeUpsert) SetOptionalFloat(v float64) *FieldTypeUpsert {
	u.Set(field_type.FieldOptionalFloat, v)
	return u
}
...
func (u *FieldTypeUpsert) UpdateOptionalFloat32() *FieldTypeUpsert {
	u.SetExcluded(field_type.FieldOptionalFloat32)
	return u
}
...
func (u *FieldTypeUpsert) AddOptionalFloat32(v float32) *FieldTypeUpsert {
	u.Add(field_type.FieldOptionalFloat32, v)
	return u
}
...
func (u *FieldTypeUpsert) UpdateLinkOtherFunc() *FieldTypeUpsert {
	u.SetExcluded(field_type.FieldLinkOtherFunc)
	return u
}
...
func (u *FieldTypeUpsert) UpdateSchemaFloat32() *FieldTypeUpsert {
	u.SetExcluded(field_type.FieldSchemaFloat32)
	return u
}
...
func (u *FieldTypeUpsert) UpdateVstring() *FieldTypeUpsert {
	u.SetExcluded(field_type.FieldVstring)
	return u
}

// SetTriple sets the "triple" field.
func (u *FieldTypeUpsert) SetTriple(v schema.Triple) *FieldTypeUpsert {
	u.Set(field_type.FieldTriple, v)
	return u
}
...
func (u *FieldTypeUpsert) UpdateTriple() *FieldTypeUpsert {
	u.SetExcluded(field_type.FieldTriple)
	return u
}

// SetBigInt sets the "big_int" field.
func (u *FieldTypeUpsert) SetBigInt(v schema.BigInt) *FieldTypeUpsert {
	u.Set(field_type.FieldBigInt, v)
	return u
}
...
// SetState sets the "state" field.
func (u *FieldTypeUpsertOne) SetState(v field_type.State) *FieldTypeUpsertOne {
	return u.Update(func(s *FieldTypeUpsert) {
		s.SetState(v)
	})
}
...
// SetState sets the "state" field.
func (u *FieldTypeUpsertBulk) SetState(v field_type.State) *FieldTypeUpsertBulk {
	return u.Update(func(s *FieldTypeUpsert) {
		s.SetState(v)
	})
}
