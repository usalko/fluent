...
func (miq *MixinIDQuery) Order(o ...mixin_i_d.OrderOption) *MixinIDQuery {
...
func (miq *MixinIDQuery) First(ctx context.Context) (*MixinID, error) {
	nodes, err := miq.Limit(1).All(setContextOp(ctx, miq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{mixin_i_d.Label}
	}
	return nodes[0], nil
}
...
func (miq *MixinIDQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
	if ids, err = miq.Limit(1).IDs(setContextOp(ctx, miq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{mixin_i_d.Label}
		return
	}
	return ids[0], nil
}
...
func (miq *MixinIDQuery) Only(ctx context.Context) (*MixinID, error) {
	nodes, err := miq.Limit(2).All(setContextOp(ctx, miq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{mixin_i_d.Label}
	default:
		return nil, &NotSingularError{mixin_i_d.Label}
	}
}
...
func (miq *MixinIDQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
	if ids, err = miq.Limit(2).IDs(setContextOp(ctx, miq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{mixin_i_d.Label}
	default:
		err = &NotSingularError{mixin_i_d.Label}
	}
	return
}
...
func (miq *MixinIDQuery) All(ctx context.Context) ([]*MixinID, error) {
	ctx = setContextOp(ctx, miq.ctx, fluent.OpQueryAll)
...
func (miq *MixinIDQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	ctx = setContextOp(ctx, miq.ctx, fluent.OpQueryIDs)
	if err = miq.Select(mixin_i_d.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (miq *MixinIDQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, miq.ctx, fluent.OpQueryCount)
	if err := miq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (miq *MixinIDQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, miq.ctx, fluent.OpQueryExist)
...
func (miq *MixinIDQuery) Clone() *MixinIDQuery {
	...
	return &MixinIDQuery{
		config:     miq.config,
		ctx:        miq.ctx.Clone(),
		order:      append([]mixin_i_d.OrderOption{}, miq.order...),
...
//		GroupBy(mixin_i_d.FieldSomeField).
...
//
//	client.MixinID.Query().
//		Select(mixin_i_d.FieldSomeField).
//		Scan(ctx, &v)
...
func (miq *MixinIDQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(mixin_i_d.Table, mixin_i_d.Columns, sqlgraph.NewFieldSpec(mixin_i_d.FieldID, field.TypeUUID))
	_spec.From = miq.sql
	...
	if fields := miq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, mixin_i_d.FieldID)
		for i := range fields {
			if fields[i] != mixin_i_d.FieldID {
...
func (miq *MixinIDQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(mixin_i_d.Table)
...
func (migb *MixinIDGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, migb.build.ctx, fluent.OpQueryGroupBy)
...
func (mis *MixinIDSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, mis.ctx, fluent.OpQuerySelect)
