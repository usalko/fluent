...
func (isu *IntSIDUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(int_s_i_d.Table, int_s_i_d.Columns, sqlgraph.NewFieldSpec(int_s_i_d.FieldID, field.TypeInt64))
	...
	if isu.mutation.ParentCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(int_s_i_d.FieldID, field.TypeInt64),
			},
		}
