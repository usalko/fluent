...
func (*MixinID) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case mixin_i_d.FieldSomeField, mixin_i_d.FieldMixinField:
			values[i] = new(sql.NullString)
		case mixin_i_d.FieldID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the MixinID.
// This includes values selected through modifiers, order, etc.
func (mi *MixinID) Value(name string) (fluent.Value, error) {
