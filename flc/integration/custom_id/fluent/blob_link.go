...
func (*BlobLink) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case blob_link.FieldBlobID, blob_link.FieldLinkID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the BlobLink.
// This includes values selected through modifiers, order, etc.
func (bl *BlobLink) Value(name string) (fluent.Value, error) {
