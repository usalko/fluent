...
var _ fluent.Mutation = (*AccountMutation)(nil)
...
// schema.
func (m *AccountMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// database failed.
func (m *AccountMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case account.FieldEmail:
...
// type.
func (m *AccountMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case account.FieldEmail:
		v, ok := value.(string)
		if !ok {
...
func (m *AccountMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AccountMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
func (m *AccountMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case account.EdgeToken:
		ids := make([]fluent.Value, 0, len(m.token))
		for id := range m.token {
			ids = append(ids, id)
		}
		return ids
...
func (m *AccountMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case account.EdgeToken:
		ids := make([]fluent.Value, 0, len(m.removedtoken))
		for id := range m.removedtoken {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*BlobMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *BlobMutation) Field(name string) (fluent.Value, bool) {
	switch name {
	case blob.FieldUUID:
		return m.UUID()
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *BlobMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case blob.FieldUUID:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BlobMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case blob.FieldUUID:
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *BlobMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	case blob.FieldCount:
		return m.AddedCount()
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BlobMutation) AddField(name string, value fluent.Value) error {
	switch name {
	case blob.FieldCount:
		v, ok := value.(int)
		if !ok {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *BlobMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	...
	case blob.EdgeLinks:
		ids := make([]fluent.Value, 0, len(m.links))
		for id := range m.links {
			ids = append(ids, id)
		}
		return ids
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *BlobMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case blob.EdgeLinks:
		ids := make([]fluent.Value, 0, len(m.removedlinks))
		for id := range m.removedlinks {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*BlobLinkMutation)(nil)
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *BlobLinkMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *BlobLinkMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *BlobLinkMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *BlobLinkMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*CarMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *CarMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *CarMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case car.FieldBeforeID:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CarMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case car.FieldBeforeID:
		v, ok := value.(float64)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *CarMutation) AddedField(name string) (fluent.Value, bool) {
	switch name {
	case car.FieldBeforeID:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CarMutation) AddField(name string, value fluent.Value) error {
	switch name {
	case car.FieldBeforeID:
		v, ok := value.(float64)
		if !ok {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *CarMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case car.EdgeOwner:
		if id := m.owner; id != nil {
			return []fluent.Value{*id}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *CarMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*DeviceMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *DeviceMutation) Field(name string) (fluent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *DeviceMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *DeviceMutation) SetField(name string, value fluent.Value) error {
	switch name {
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *DeviceMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *DeviceMutation) AddField(name string, value fluent.Value) error {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *DeviceMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *DeviceMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case device.EdgeSessions:
...
var _ fluent.Mutation = (*DocMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *DocMutation) Field(name string) (fluent.Value, bool) {
	switch name {
	case doc.FieldText:
		return m.Text()
	}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *DocMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case doc.FieldText:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *DocMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case doc.FieldText:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *DocMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *DocMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *DocMutation) AddedIDs(name string) []fluent.Value {
	switch name {
	case doc.EdgeParent:
		if id := m.parent; id != nil {
			return []fluent.Value{*id}
	...
	case doc.EdgeRelated:
		ids := make([]fluent.Value, 0, len(m.related))
		for id := range m.related {
			ids = append(ids, id)
		}
		return ids
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *DocMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case doc.EdgeChildren:
		...
		return ids
	case doc.EdgeRelated:
		ids := make([]fluent.Value, 0, len(m.removedrelated))
		for id := range m.removedrelated {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*IntSIDMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *IntSIDMutation) Field(name string) (fluent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *IntSIDMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *IntSIDMutation) SetField(name string, value fluent.Value) error {
	switch name {
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *IntSIDMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *IntSIDMutation) AddField(name string, value fluent.Value) error {
...
var _ fluent.Mutation = (*LinkMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *LinkMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *LinkMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case link.FieldLinkInformation:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LinkMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case link.FieldLinkInformation:
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *LinkMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LinkMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *LinkMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *LinkMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*MixinIDMutation)(nil)
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *MixinIDMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *MixinIDMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *MixinIDMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *MixinIDMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*NoteMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *NoteMutation) Field(name string) (fluent.Value, bool) {
	switch name {
	case note.FieldText:
		return m.Text()
	}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *NoteMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case note.FieldText:
		return m.OldText(ctx)
	}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *NoteMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case note.FieldText:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *NoteMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *NoteMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *NoteMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *NoteMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case note.EdgeChildren:
		ids := make([]fluent.Value, 0, len(m.removedchildren))
		for id := range m.removedchildren {
...
var _ fluent.Mutation = (*OtherMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *OtherMutation) Field(name string) (fluent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *OtherMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *OtherMutation) SetField(name string, value fluent.Value) error {
	switch name {
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *OtherMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *OtherMutation) AddField(name string, value fluent.Value) error {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *OtherMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *OtherMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
func (m *PetMutation) AddedIDs(name string) []fluent.Value {
	...
	case pet.EdgeCars:
		ids := make([]fluent.Value, 0, len(m.cars))
		for id := range m.cars {
			ids = append(ids, id)
		}
		return ids
...
func (m *PetMutation) RemovedIDs(name string) []fluent.Value {
	switch name {
	case pet.EdgeCars:
		ids := make([]fluent.Value, 0, len(m.removedcars))
		for id := range m.removedcars {
			ids = append(ids, id)
		}
		return ids
...
var _ fluent.Mutation = (*RevisionMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *RevisionMutation) Field(name string) (fluent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *RevisionMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RevisionMutation) SetField(name string, value fluent.Value) error {
	switch name {
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *RevisionMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *RevisionMutation) AddField(name string, value fluent.Value) error {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *RevisionMutation) AddedIDs(name string) []fluent.Value {
	return nil
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *RevisionMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*SessionMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SessionMutation) Field(name string) (fluent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SessionMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SessionMutation) SetField(name string, value fluent.Value) error {
	switch name {
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SessionMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SessionMutation) AddField(name string, value fluent.Value) error {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SessionMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SessionMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
...
var _ fluent.Mutation = (*TokenMutation)(nil)
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *TokenMutation) Field(name string) (fluent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *TokenMutation) OldField(ctx context.Context, name string) (fluent.Value, error) {
	switch name {
	case token.FieldBody:
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TokenMutation) SetField(name string, value fluent.Value) error {
	switch name {
	case token.FieldBody:
		v, ok := value.(string)
		if !ok {
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *TokenMutation) AddedField(name string) (fluent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TokenMutation) AddField(name string, value fluent.Value) error {
	switch name {
	}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *TokenMutation) AddedIDs(name string) []fluent.Value {
	switch name {
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TokenMutation) RemovedIDs(name string) []fluent.Value {
	return nil
}
