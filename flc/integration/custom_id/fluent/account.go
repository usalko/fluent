...
// Value returns the fluent.Value that was dynamically selected and assigned to the Account.
// This includes values selected through modifiers, order, etc.
func (a *Account) Value(name string) (fluent.Value, error) {
...
func (a *Account) Unwrap() *Account {
	...
	if !ok {
		panic("fluent: Account is not a transactional entity")
	}
