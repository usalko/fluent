...
func (lc *LinkCreate) SetLinkInformation(map_string_schema_linkinformation map[string]schema.LinkInformation) *LinkCreate {
	lc.mutation.SetLinkInformation(map_string_schema_linkinformation)
	return lc
}

// SetID sets the "id" field.
func (lc *LinkCreate) SetID(uuidc_uuidc uuidc.UUIDC) *LinkCreate {
	lc.mutation.SetID(uuidc_uuidc)
	return lc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (lc *LinkCreate) SetNillableID(uuidc_uuidc *uuidc.UUIDC) *LinkCreate {
	if uuidc_uuidc != nil {
		lc.SetID(*uuidc_uuidc)
	}
	return lc
}
...
//		// update values.
//		Update(func(u *fluent.LinkUpsert) {
...
func (u *LinkUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("fluent: missing options for LinkCreate.OnConflict")
	}
...
func (u *LinkUpsertOne) ID(ctx context.Context) (id uuidc.UUIDC, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		...
		return id, errors.New("fluent: LinkUpsertOne.ID is not supported by MySQL driver. Use LinkUpsertOne.Exec instead")
	}
...
func (u *LinkUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("fluent: OnConflict was set for builder %d. Set it on the LinkCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("fluent: missing options for LinkCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
