...
func (isq *IntSIDQuery) Order(o ...int_s_i_d.OrderOption) *IntSIDQuery {
...
func (isq *IntSIDQuery) QueryParent() *IntSIDQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(int_s_i_d.Table, int_s_i_d.FieldID, selector),
...
func (isq *IntSIDQuery) First(ctx context.Context) (*IntSID, error) {
	nodes, err := isq.Limit(1).All(setContextOp(ctx, isq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{int_s_i_d.Label}
	}
	return nodes[0], nil
}
...
func (isq *IntSIDQuery) FirstID(ctx context.Context) (id sid.ID, err error) {
	var ids []sid.ID
	if ids, err = isq.Limit(1).IDs(setContextOp(ctx, isq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{int_s_i_d.Label}
		return
	}
	return ids[0], nil
}
...
func (isq *IntSIDQuery) Only(ctx context.Context) (*IntSID, error) {
	nodes, err := isq.Limit(2).All(setContextOp(ctx, isq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{int_s_i_d.Label}
	default:
		return nil, &NotSingularError{int_s_i_d.Label}
	}
}
...
func (isq *IntSIDQuery) OnlyID(ctx context.Context) (id sid.ID, err error) {
	var ids []sid.ID
	if ids, err = isq.Limit(2).IDs(setContextOp(ctx, isq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{int_s_i_d.Label}
	default:
		err = &NotSingularError{int_s_i_d.Label}
	}
	return
}
...
func (isq *IntSIDQuery) All(ctx context.Context) ([]*IntSID, error) {
	ctx = setContextOp(ctx, isq.ctx, fluent.OpQueryAll)
	if err := isq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (isq *IntSIDQuery) IDs(ctx context.Context) (ids []sid.ID, err error) {
	...
	ctx = setContextOp(ctx, isq.ctx, fluent.OpQueryIDs)
	if err = isq.Select(int_s_i_d.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (isq *IntSIDQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, isq.ctx, fluent.OpQueryCount)
	if err := isq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (isq *IntSIDQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, isq.ctx, fluent.OpQueryExist)
...
func (isq *IntSIDQuery) Clone() *IntSIDQuery {
	...
	return &IntSIDQuery{
		config:       isq.config,
		ctx:          isq.ctx.Clone(),
		order:        append([]int_s_i_d.OrderOption{}, isq.order...),
...
func (isq *IntSIDQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*IntSID, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, int_s_i_d.ForeignKeys...)
	}
...
func (isq *IntSIDQuery) loadParent(ctx context.Context, query *IntSIDQuery, nodes []*IntSID, init func(*IntSID), assign func(*IntSID, *IntSID)) error {
	...
	query.Where(int_s_i_d.IDIn(ids...))
...
func (isq *IntSIDQuery) loadChildren(ctx context.Context, query *IntSIDQuery, nodes []*IntSID, init func(*IntSID), assign func(*IntSID, *IntSID)) error {
	...
	query.Where(predicate.IntSID(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(int_s_i_d.ChildrenColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (isq *IntSIDQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(int_s_i_d.Table, int_s_i_d.Columns, sqlgraph.NewFieldSpec(int_s_i_d.FieldID, field.TypeInt64))
	_spec.From = isq.sql
	...
	if fields := isq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, int_s_i_d.FieldID)
		for i := range fields {
			if fields[i] != int_s_i_d.FieldID {
...
func (isq *IntSIDQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(int_s_i_d.Table)
...
func (isgb *IntSIDGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, isgb.build.ctx, fluent.OpQueryGroupBy)
...
func (iss *IntSIDSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, iss.ctx, fluent.OpQuerySelect)
