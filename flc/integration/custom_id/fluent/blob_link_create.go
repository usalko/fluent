...
func (blc *BlobLinkCreate) SetCreatedAt(time_time time.Time) *BlobLinkCreate {
	blc.mutation.SetCreatedAt(time_time)
	return blc
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (blc *BlobLinkCreate) SetNillableCreatedAt(time_time *time.Time) *BlobLinkCreate {
	if time_time != nil {
		blc.SetCreatedAt(*time_time)
	}
	return blc
}

// SetBlobID sets the "blob_id" field.
func (blc *BlobLinkCreate) SetBlobID(uuid_uuid uuid.UUID) *BlobLinkCreate {
	blc.mutation.SetBlobID(uuid_uuid)
	return blc
}

// SetLinkID sets the "link_id" field.
func (blc *BlobLinkCreate) SetLinkID(uuid_uuid uuid.UUID) *BlobLinkCreate {
	blc.mutation.SetLinkID(uuid_uuid)
	return blc
}
...
func (blc *BlobLinkCreate) createSpec() (*BlobLink, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(blob_link.Table, nil)
	)
...
//		// update values.
//		Update(func(u *fluent.BlobLinkUpsert) {
//			SetCreatedAt(v+v).
//		}).
//		Exec(ctx)
...
func (u *BlobLinkUpsert) UpdateBlobID() *BlobLinkUpsert {
	u.SetExcluded(blob_link.FieldBlobID)
	return u
}

// SetLinkID sets the "link_id" field.
func (u *BlobLinkUpsert) SetLinkID(v uuid.UUID) *BlobLinkUpsert {
	u.Set(blob_link.FieldLinkID, v)
	return u
}
...
func (u *BlobLinkUpsert) UpdateLinkID() *BlobLinkUpsert {
	u.SetExcluded(blob_link.FieldLinkID)
	return u
}
