...
func (c *AccountClient) mutate(ctx context.Context, m *AccountMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Account mutation op: %q", m.Op())
	}
}
...
func (c *BlobClient) mutate(ctx context.Context, m *BlobMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Blob mutation op: %q", m.Op())
	}
}
...
func (c *BlobLinkClient) mutate(ctx context.Context, m *BlobLinkMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown BlobLink mutation op: %q", m.Op())
	}
}
...
func (c *CarClient) mutate(ctx context.Context, m *CarMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Car mutation op: %q", m.Op())
	}
}
...
func (c *DeviceClient) mutate(ctx context.Context, m *DeviceMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Device mutation op: %q", m.Op())
	}
}
...
func (c *DocClient) mutate(ctx context.Context, m *DocMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Doc mutation op: %q", m.Op())
	}
}
...
// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `int_sid.Hooks(f(g(h())))`.
func (c *IntSIDClient) Use(hooks ...Hook) {
	c.hooks.IntSID = append(c.hooks.IntSID, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `int_sid.Intercept(f(g(h())))`.
...
func (c *IntSIDClient) DeleteOneID(id sid.ID) *IntSIDDeleteOne {
	builder := c.Delete().Where(int_sid.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *IntSIDClient) Get(ctx context.Context, id sid.ID) (*IntSID, error) {
	return c.Query().Where(int_sid.ID(id)).Only(ctx)
}
...
func (c *IntSIDClient) QueryParent(is *IntSID) *IntSIDQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := is.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(int_sid.Table, int_sid.FieldID, id),
...
func (c *IntSIDClient) mutate(ctx context.Context, m *IntSIDMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown IntSID mutation op: %q", m.Op())
	}
}
...
func (c *LinkClient) mutate(ctx context.Context, m *LinkMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Link mutation op: %q", m.Op())
	}
}
...
// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `mixin_id.Hooks(f(g(h())))`.
func (c *MixinIDClient) Use(hooks ...Hook) {
	c.hooks.MixinID = append(c.hooks.MixinID, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `mixin_id.Intercept(f(g(h())))`.
...
func (c *MixinIDClient) DeleteOneID(id uuid.UUID) *MixinIDDeleteOne {
	builder := c.Delete().Where(mixin_id.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *MixinIDClient) Get(ctx context.Context, id uuid.UUID) (*MixinID, error) {
	return c.Query().Where(mixin_id.ID(id)).Only(ctx)
}
...
func (c *MixinIDClient) mutate(ctx context.Context, m *MixinIDMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown MixinID mutation op: %q", m.Op())
	}
}
...
func (c *NoteClient) mutate(ctx context.Context, m *NoteMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Note mutation op: %q", m.Op())
	}
}
...
func (c *OtherClient) mutate(ctx context.Context, m *OtherMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Other mutation op: %q", m.Op())
	}
}
...
func (c *PetClient) mutate(ctx context.Context, m *PetMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Pet mutation op: %q", m.Op())
	}
}
...
func (c *RevisionClient) mutate(ctx context.Context, m *RevisionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Revision mutation op: %q", m.Op())
	}
}
...
func (c *SessionClient) mutate(ctx context.Context, m *SessionMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Session mutation op: %q", m.Op())
	}
}
...
func (c *TokenClient) mutate(ctx context.Context, m *TokenMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Token mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		...
		Other, Pet, Revision, Session, Token, User []fluent.Hook
	}
	inters struct {
		Account, Blob, BlobLink, Car, Device, Doc, Group, IntSID, Link, MixinID, Note,
		Other, Pet, Revision, Session, Token, User []fluent.Interceptor
	}
)
