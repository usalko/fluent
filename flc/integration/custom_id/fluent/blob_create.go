...
func (bc *BlobCreate) SetUUID(uuid_uuid uuid.UUID) *BlobCreate {
	bc.mutation.SetUUID(uuid_uuid)
	return bc
}

// SetNillableUUID sets the "uuid" field if the given value is not nil.
func (bc *BlobCreate) SetNillableUUID(uuid_uuid *uuid.UUID) *BlobCreate {
	if uuid_uuid != nil {
		bc.SetUUID(*uuid_uuid)
	}
	return bc
}
...
func (bc *BlobCreate) SetID(uuid_uuid uuid.UUID) *BlobCreate {
	bc.mutation.SetID(uuid_uuid)
	return bc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (bc *BlobCreate) SetNillableID(uuid_uuid *uuid.UUID) *BlobCreate {
	if uuid_uuid != nil {
		bc.SetID(*uuid_uuid)
	}
	return bc
...
//		// update values.
//		Update(func(u *fluent.BlobUpsert) {
//			SetUUID(v+v).
//		}).
//		Exec(ctx)
...
func (u *BlobUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("fluent: missing options for BlobCreate.OnConflict")
	}
...
func (u *BlobUpsertOne) ID(ctx context.Context) (id uuid.UUID, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		...
		return id, errors.New("fluent: BlobUpsertOne.ID is not supported by MySQL driver. Use BlobUpsertOne.Exec instead")
	}
...
func (u *BlobUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("fluent: OnConflict was set for builder %d. Set it on the BlobCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("fluent: missing options for BlobCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
