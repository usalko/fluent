...
func (oq *OtherQuery) First(ctx context.Context) (*Other, error) {
	nodes, err := oq.Limit(1).All(setContextOp(ctx, oq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (oq *OtherQuery) FirstID(ctx context.Context) (id sid.ID, err error) {
	var ids []sid.ID
	if ids, err = oq.Limit(1).IDs(setContextOp(ctx, oq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (oq *OtherQuery) Only(ctx context.Context) (*Other, error) {
	nodes, err := oq.Limit(2).All(setContextOp(ctx, oq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (oq *OtherQuery) OnlyID(ctx context.Context) (id sid.ID, err error) {
	var ids []sid.ID
	if ids, err = oq.Limit(2).IDs(setContextOp(ctx, oq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (oq *OtherQuery) All(ctx context.Context) ([]*Other, error) {
	ctx = setContextOp(ctx, oq.ctx, fluent.OpQueryAll)
...
func (oq *OtherQuery) IDs(ctx context.Context) (ids []sid.ID, err error) {
	...
	ctx = setContextOp(ctx, oq.ctx, fluent.OpQueryIDs)
...
func (oq *OtherQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, oq.ctx, fluent.OpQueryCount)
	if err := oq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (oq *OtherQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, oq.ctx, fluent.OpQueryExist)
...
func (ogb *OtherGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ogb.build.ctx, fluent.OpQueryGroupBy)
...
func (os *OtherSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, os.ctx, fluent.OpQuerySelect)
