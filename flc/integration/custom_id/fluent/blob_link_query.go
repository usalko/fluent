...
func (blq *BlobLinkQuery) Order(o ...blob_link.OrderOption) *BlobLinkQuery {
...
func (blq *BlobLinkQuery) QueryBlob() *BlobQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(blob_link.Table, blob_link.BlobColumn, selector),
			sqlgraph.To(blob.Table, blob.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, blob_link.BlobTable, blob_link.BlobColumn),
		)
...
func (blq *BlobLinkQuery) QueryLink() *BlobQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(blob_link.Table, blob_link.LinkColumn, selector),
			sqlgraph.To(blob.Table, blob.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, false, blob_link.LinkTable, blob_link.LinkColumn),
		)
		fromU = sqlgraph.SetNeighbors(blq.driver.Dialect(), step)
		return fromU, nil
	}
...
func (blq *BlobLinkQuery) First(ctx context.Context) (*BlobLink, error) {
	nodes, err := blq.Limit(1).All(setContextOp(ctx, blq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{blob_link.Label}
	}
	return nodes[0], nil
}
...
func (blq *BlobLinkQuery) Only(ctx context.Context) (*BlobLink, error) {
	nodes, err := blq.Limit(2).All(setContextOp(ctx, blq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{blob_link.Label}
	default:
		return nil, &NotSingularError{blob_link.Label}
	}
}
...
func (blq *BlobLinkQuery) All(ctx context.Context) ([]*BlobLink, error) {
	ctx = setContextOp(ctx, blq.ctx, fluent.OpQueryAll)
	if err := blq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (blq *BlobLinkQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, blq.ctx, fluent.OpQueryCount)
	if err := blq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (blq *BlobLinkQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, blq.ctx, fluent.OpQueryExist)
...
func (blq *BlobLinkQuery) Clone() *BlobLinkQuery {
	...
	return &BlobLinkQuery{
		config:     blq.config,
		ctx:        blq.ctx.Clone(),
		order:      append([]blob_link.OrderOption{}, blq.order...),
...
//		GroupBy(blob_link.FieldCreatedAt).
...
//
//	client.BlobLink.Query().
//		Select(blob_link.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (blq *BlobLinkQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(blob_link.Table, blob_link.Columns, nil)
	_spec.From = blq.sql
	...
	if fields := blq.ctx.Fields; len(fields) > 0 {
		...
		if blq.withBlob != nil {
			_spec.Node.AddColumnOnce(blob_link.FieldBlobID)
		}
		if blq.withLink != nil {
			_spec.Node.AddColumnOnce(blob_link.FieldLinkID)
		}
	}
...
func (blq *BlobLinkQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(blob_link.Table)
...
func (blgb *BlobLinkGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, blgb.build.ctx, fluent.OpQueryGroupBy)
...
func (bls *BlobLinkSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, bls.ctx, fluent.OpQuerySelect)
