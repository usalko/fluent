...
func (dq *DocQuery) First(ctx context.Context) (*Doc, error) {
	nodes, err := dq.Limit(1).All(setContextOp(ctx, dq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (dq *DocQuery) FirstID(ctx context.Context) (id schema.DocID, err error) {
	...
	if ids, err = dq.Limit(1).IDs(setContextOp(ctx, dq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (dq *DocQuery) Only(ctx context.Context) (*Doc, error) {
	nodes, err := dq.Limit(2).All(setContextOp(ctx, dq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (dq *DocQuery) OnlyID(ctx context.Context) (id schema.DocID, err error) {
	var ids []schema.DocID
	if ids, err = dq.Limit(2).IDs(setContextOp(ctx, dq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
...
func (dq *DocQuery) All(ctx context.Context) ([]*Doc, error) {
	ctx = setContextOp(ctx, dq.ctx, fluent.OpQueryAll)
	if err := dq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (dq *DocQuery) IDs(ctx context.Context) (ids []schema.DocID, err error) {
	...
	ctx = setContextOp(ctx, dq.ctx, fluent.OpQueryIDs)
...
func (dq *DocQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, dq.ctx, fluent.OpQueryCount)
	if err := dq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (dq *DocQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, dq.ctx, fluent.OpQueryExist)
...
func (dgb *DocGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, dgb.build.ctx, fluent.OpQueryGroupBy)
...
func (ds *DocSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, ds.ctx, fluent.OpQuerySelect)
