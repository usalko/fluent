...
func (isc *IntSIDCreate) createSpec() (*IntSID, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(int_s_i_d.Table, sqlgraph.NewFieldSpec(int_s_i_d.FieldID, field.TypeInt64))
	)
