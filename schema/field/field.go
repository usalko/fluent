...
// Descriptor implements the fluent.Field interface by returning its descriptor.
...
//	field.Time("deleted_at").
//		Annotations(
//			 fluent_gql.OrderField("DELETED_AT"),
//		)
