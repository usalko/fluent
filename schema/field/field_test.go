...
func TestInt(t *testing.T) {
	...
	assert.Equal(t, "github.com/usalko/fluent/schema/field_test", fd.Info.PkgPath)
...
func TestJSON(t *testing.T) {
	...
	assert.Equal(t, "github.com/usalko/fluent/schema/field_test", fd.Info.RType.PkgPath)
