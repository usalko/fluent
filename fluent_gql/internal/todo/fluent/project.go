...
// Value returns the fluent.Value that was dynamically selected and assigned to the Project.
// This includes values selected through modifiers, order, etc.
func (pr *Project) Value(name string) (fluent.Value, error) {
...
func (pr *Project) Unwrap() *Project {
	...
	if !ok {
		panic("fluent: Project is not a transactional entity")
	}
