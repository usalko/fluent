...
func (otmq *OneToManyQuery) Order(o ...one_to_many.OrderOption) *OneToManyQuery {
...
func (otmq *OneToManyQuery) QueryParent() *OneToManyQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(one_to_many.Table, one_to_many.FieldID, selector),
			sqlgraph.To(one_to_many.Table, one_to_many.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, one_to_many.ParentTable, one_to_many.ParentColumn),
		)
...
func (otmq *OneToManyQuery) QueryChildren() *OneToManyQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(one_to_many.Table, one_to_many.FieldID, selector),
			sqlgraph.To(one_to_many.Table, one_to_many.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, one_to_many.ChildrenTable, one_to_many.ChildrenColumn),
		)
		fromU = sqlgraph.SetNeighbors(otmq.driver.Dialect(), step)
		return fromU, nil
	}
...
func (otmq *OneToManyQuery) First(ctx context.Context) (*OneToMany, error) {
	nodes, err := otmq.Limit(1).All(setContextOp(ctx, otmq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{one_to_many.Label}
	}
	return nodes[0], nil
}
...
func (otmq *OneToManyQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = otmq.Limit(1).IDs(setContextOp(ctx, otmq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{one_to_many.Label}
		return
	}
	return ids[0], nil
}
...
func (otmq *OneToManyQuery) Only(ctx context.Context) (*OneToMany, error) {
	nodes, err := otmq.Limit(2).All(setContextOp(ctx, otmq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{one_to_many.Label}
	default:
		return nil, &NotSingularError{one_to_many.Label}
	}
}
...
func (otmq *OneToManyQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	if ids, err = otmq.Limit(2).IDs(setContextOp(ctx, otmq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{one_to_many.Label}
	default:
		err = &NotSingularError{one_to_many.Label}
	}
	return
}
...
func (otmq *OneToManyQuery) All(ctx context.Context) ([]*OneToMany, error) {
	ctx = setContextOp(ctx, otmq.ctx, fluent.OpQueryAll)
	if err := otmq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (otmq *OneToManyQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	ctx = setContextOp(ctx, otmq.ctx, fluent.OpQueryIDs)
	if err = otmq.Select(one_to_many.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (otmq *OneToManyQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, otmq.ctx, fluent.OpQueryCount)
	if err := otmq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (otmq *OneToManyQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, otmq.ctx, fluent.OpQueryExist)
...
func (otmq *OneToManyQuery) Clone() *OneToManyQuery {
	...
	return &OneToManyQuery{
		config:       otmq.config,
		ctx:          otmq.ctx.Clone(),
		order:        append([]one_to_many.OrderOption{}, otmq.order...),
...
func (otmq *OneToManyQuery) GroupBy(field string, fields ...string) *OneToManyGroupBy {
	...
	grbuild.label = one_to_many.Label
...
func (otmq *OneToManyQuery) Select(fields ...string) *OneToManySelect {
	...
	sbuild.label = one_to_many.Label
...
func (otmq *OneToManyQuery) loadParent(ctx context.Context, query *OneToManyQuery, nodes []*OneToMany, init func(*OneToMany), assign func(*OneToMany, *OneToMany)) error {
	...
	query.Where(one_to_many.IDIn(ids...))
...
func (otmq *OneToManyQuery) loadChildren(ctx context.Context, query *OneToManyQuery, nodes []*OneToMany, init func(*OneToMany), assign func(*OneToMany, *OneToMany)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(one_to_many.FieldParentID)
	}
	query.Where(predicate.OneToMany(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(one_to_many.ChildrenColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (otmq *OneToManyQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(one_to_many.Table, one_to_many.Columns, sqlgraph.NewFieldSpec(one_to_many.FieldID, field.TypeInt))
	_spec.From = otmq.sql
	...
	if fields := otmq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, one_to_many.FieldID)
		for i := range fields {
			if fields[i] != one_to_many.FieldID {
				_spec.Node.Columns = append(_spec.Node.Columns, fields[i])
			}
		}
		if otmq.withParent != nil {
			_spec.Node.AddColumnOnce(one_to_many.FieldParentID)
		}
	}
...
func (otmq *OneToManyQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(one_to_many.Table)
	columns := otmq.ctx.Fields
	if len(columns) == 0 {
		columns = one_to_many.Columns
	}
...
func (otmgb *OneToManyGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, otmgb.build.ctx, fluent.OpQueryGroupBy)
...
func (otms *OneToManySelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, otms.ctx, fluent.OpQuerySelect)
