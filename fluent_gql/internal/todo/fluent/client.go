...
func (c *BillProductClient) mutate(ctx context.Context, m *BillProductMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown BillProduct mutation op: %q", m.Op())
	}
}
...
func (c *CategoryClient) mutate(ctx context.Context, m *CategoryMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Category mutation op: %q", m.Op())
	}
}
...
// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `one_to_many.Hooks(f(g(h())))`.
func (c *OneToManyClient) Use(hooks ...Hook) {
	c.hooks.OneToMany = append(c.hooks.OneToMany, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `one_to_many.Intercept(f(g(h())))`.
...
func (c *OneToManyClient) DeleteOneID(id int) *OneToManyDeleteOne {
	builder := c.Delete().Where(one_to_many.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *OneToManyClient) Get(ctx context.Context, id int) (*OneToMany, error) {
	return c.Query().Where(one_to_many.ID(id)).Only(ctx)
}
...
func (c *OneToManyClient) QueryParent(otm *OneToMany) *OneToManyQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := otm.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(one_to_many.Table, one_to_many.FieldID, id),
...
func (c *OneToManyClient) mutate(ctx context.Context, m *OneToManyMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown OneToMany mutation op: %q", m.Op())
	}
}
...
func (c *ProjectClient) mutate(ctx context.Context, m *ProjectMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Project mutation op: %q", m.Op())
	}
}
...
func (c *TodoClient) mutate(ctx context.Context, m *TodoMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Todo mutation op: %q", m.Op())
	}
}
...
func (c *VerySecretClient) mutate(ctx context.Context, m *VerySecretMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown VerySecret mutation op: %q", m.Op())
	}
}
...
func (c *WorkspaceClient) mutate(ctx context.Context, m *WorkspaceMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Workspace mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		...
		VerySecret, Workspace []fluent.Hook
	}
	inters struct {
		BillProduct, Category, Friendship, Group, OneToMany, Project, Todo, User,
		VerySecret, Workspace []fluent.Interceptor
	}
)
