...
import (
	...
	"github.com/usalko/fluent/fluent_gql/internal/todo_fed"
	...
	_ "github.com/usalko/fluent/fluent_gql/internal/todo_fed/fluent/runtime"
)
...
func main() {
	...
	srv := handler.NewDefaultServer(todo_fed.NewSchema(client))
