...
func (tc *TodoCreate) SetCategoryID(bigintgql_bigint bigintgql.BigInt) *TodoCreate {
	tc.mutation.SetCategoryID(bigintgql_bigint)
	return tc
}

// SetNillableCategoryID sets the "category_id" field if the given value is not nil.
func (tc *TodoCreate) SetNillableCategoryID(bigintgql_bigint *bigintgql.BigInt) *TodoCreate {
	if bigintgql_bigint != nil {
		tc.SetCategoryID(*bigintgql_bigint)
	}
	return tc
}
