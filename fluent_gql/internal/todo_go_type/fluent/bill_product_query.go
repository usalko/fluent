...
type BillProductQuery struct {
	config
	ctx        *QueryContext
	order      []bill_product.OrderOption
	inters     []Interceptor
...
func (bpq *BillProductQuery) Order(o ...bill_product.OrderOption) *BillProductQuery {
...
func (bpq *BillProductQuery) First(ctx context.Context) (*BillProduct, error) {
	nodes, err := bpq.Limit(1).All(setContextOp(ctx, bpq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{bill_product.Label}
	}
	return nodes[0], nil
}
...
func (bpq *BillProductQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = bpq.Limit(1).IDs(setContextOp(ctx, bpq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (bpq *BillProductQuery) Only(ctx context.Context) (*BillProduct, error) {
	nodes, err := bpq.Limit(2).All(setContextOp(ctx, bpq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{bill_product.Label}
	default:
		return nil, &NotSingularError{bill_product.Label}
	}
}
...
func (bpq *BillProductQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
	if ids, err = bpq.Limit(2).IDs(setContextOp(ctx, bpq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{bill_product.Label}
	default:
		err = &NotSingularError{bill_product.Label}
	}
	return
}
...
func (bpq *BillProductQuery) All(ctx context.Context) ([]*BillProduct, error) {
	ctx = setContextOp(ctx, bpq.ctx, fluent.OpQueryAll)
...
func (bpq *BillProductQuery) IDs(ctx context.Context) (ids []string, err error) {
	...
	ctx = setContextOp(ctx, bpq.ctx, fluent.OpQueryIDs)
	if err = bpq.Select(bill_product.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (bpq *BillProductQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, bpq.ctx, fluent.OpQueryCount)
	if err := bpq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (bpq *BillProductQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, bpq.ctx, fluent.OpQueryExist)
...
func (bpq *BillProductQuery) Clone() *BillProductQuery {
	...
	return &BillProductQuery{
		config:     bpq.config,
		ctx:        bpq.ctx.Clone(),
		order:      append([]bill_product.OrderOption{}, bpq.order...),
...
//		GroupBy(bill_product.FieldName).
...
func (bpq *BillProductQuery) GroupBy(field string, fields ...string) *BillProductGroupBy {
	...
	grbuild.label = bill_product.Label
...
func (bpq *BillProductQuery) Select(fields ...string) *BillProductSelect {
	...
	sbuild.label = bill_product.Label
...
func (bpq *BillProductQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(bill_product.Table, bill_product.Columns, sqlgraph.NewFieldSpec(bill_product.FieldID, field.TypeString))
	_spec.From = bpq.sql
	...
	if fields := bpq.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != bill_product.FieldID {
...
func (bpq *BillProductQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(bill_product.Table)
	columns := bpq.ctx.Fields
	if len(columns) == 0 {
		columns = bill_product.Columns
	}
...
func (bpgb *BillProductGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, bpgb.build.ctx, fluent.OpQueryGroupBy)
...
func (bps *BillProductSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, bps.ctx, fluent.OpQuerySelect)
