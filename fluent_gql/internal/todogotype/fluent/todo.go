...
// GetValue returns the fluent.Value that was dynamically selected and assigned to the Todo.
// This includes values selected through modifiers, order, etc.
func (t *Todo) GetValue(name string) (fluent.Value, error) {
...
func (t *Todo) Unwrap() *Todo {
	...
	if !ok {
		panic("fluent: Todo is not a transactional entity")
	}
