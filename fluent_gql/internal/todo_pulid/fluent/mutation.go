...
func (m *FriendshipMutation) SetUserID(pulid_id pulid.ID) {
	m.user = &pulid_id
}
...
func (m *FriendshipMutation) SetFriendID(pulid_id pulid.ID) {
	m.friend = &pulid_id
}
...
func (m *TodoMutation) SetCategoryID(pulid_id pulid.ID) {
	m.category = &pulid_id
}
