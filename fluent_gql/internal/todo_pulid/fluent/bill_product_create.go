...
func (bpc *BillProductCreate) SetID(pulid_id pulid.ID) *BillProductCreate {
	bpc.mutation.SetID(pulid_id)
	return bpc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (bpc *BillProductCreate) SetNillableID(pulid_id *pulid.ID) *BillProductCreate {
	if pulid_id != nil {
		bpc.SetID(*pulid_id)
	}
	return bpc
...
func (bpc *BillProductCreate) createSpec() (*BillProduct, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(bill_product.Table, sqlgraph.NewFieldSpec(bill_product.FieldID, field.TypeString))
	)
