...
func (vsq *VerySecretQuery) Order(o ...very_secret.OrderOption) *VerySecretQuery {
...
func (vsq *VerySecretQuery) First(ctx context.Context) (*VerySecret, error) {
	nodes, err := vsq.Limit(1).All(setContextOp(ctx, vsq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{very_secret.Label}
	}
	return nodes[0], nil
}
...
func (vsq *VerySecretQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
	if ids, err = vsq.Limit(1).IDs(setContextOp(ctx, vsq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
		err = &NotFoundError{very_secret.Label}
		return
	}
	return ids[0], nil
}
...
func (vsq *VerySecretQuery) Only(ctx context.Context) (*VerySecret, error) {
	nodes, err := vsq.Limit(2).All(setContextOp(ctx, vsq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{very_secret.Label}
	default:
		return nil, &NotSingularError{very_secret.Label}
	}
}
...
func (vsq *VerySecretQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
	if ids, err = vsq.Limit(2).IDs(setContextOp(ctx, vsq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{very_secret.Label}
	default:
		err = &NotSingularError{very_secret.Label}
	}
	return
}
...
func (vsq *VerySecretQuery) All(ctx context.Context) ([]*VerySecret, error) {
	ctx = setContextOp(ctx, vsq.ctx, fluent.OpQueryAll)
...
func (vsq *VerySecretQuery) IDs(ctx context.Context) (ids []pulid.ID, err error) {
	...
	ctx = setContextOp(ctx, vsq.ctx, fluent.OpQueryIDs)
	if err = vsq.Select(very_secret.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (vsq *VerySecretQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, vsq.ctx, fluent.OpQueryCount)
	if err := vsq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (vsq *VerySecretQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, vsq.ctx, fluent.OpQueryExist)
...
func (vsq *VerySecretQuery) Clone() *VerySecretQuery {
	...
	return &VerySecretQuery{
		config:     vsq.config,
		ctx:        vsq.ctx.Clone(),
		order:      append([]very_secret.OrderOption{}, vsq.order...),
...
//		GroupBy(very_secret.FieldPassword).
...
func (vsq *VerySecretQuery) GroupBy(field string, fields ...string) *VerySecretGroupBy {
	...
	grbuild.label = very_secret.Label
...
//
//	client.VerySecret.Query().
//		Select(very_secret.FieldPassword).
//		Scan(ctx, &v)
func (vsq *VerySecretQuery) Select(fields ...string) *VerySecretSelect {
	...
	sbuild.label = very_secret.Label
...
func (vsq *VerySecretQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(very_secret.Table, very_secret.Columns, sqlgraph.NewFieldSpec(very_secret.FieldID, field.TypeString))
	_spec.From = vsq.sql
	...
	if fields := vsq.ctx.Fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, very_secret.FieldID)
		for i := range fields {
			if fields[i] != very_secret.FieldID {
...
func (vsq *VerySecretQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(very_secret.Table)
	columns := vsq.ctx.Fields
	if len(columns) == 0 {
		columns = very_secret.Columns
	}
...
func (vsgb *VerySecretGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, vsgb.build.ctx, fluent.OpQueryGroupBy)
...
func (vss *VerySecretSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, vss.ctx, fluent.OpQuerySelect)
