...
func (vsc *VerySecretCreate) SetID(pulid_id pulid.ID) *VerySecretCreate {
	vsc.mutation.SetID(pulid_id)
	return vsc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (vsc *VerySecretCreate) SetNillableID(pulid_id *pulid.ID) *VerySecretCreate {
	if pulid_id != nil {
		vsc.SetID(*pulid_id)
	}
	return vsc
...
func (vsc *VerySecretCreate) createSpec() (*VerySecret, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(very_secret.Table, sqlgraph.NewFieldSpec(very_secret.FieldID, field.TypeString))
	)
