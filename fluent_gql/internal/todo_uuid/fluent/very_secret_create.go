...
func (vsc *VerySecretCreate) SetID(uuid_uuid uuid.UUID) *VerySecretCreate {
	vsc.mutation.SetID(uuid_uuid)
	return vsc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (vsc *VerySecretCreate) SetNillableID(uuid_uuid *uuid.UUID) *VerySecretCreate {
	if uuid_uuid != nil {
		vsc.SetID(*uuid_uuid)
	}
	return vsc
...
func (vsc *VerySecretCreate) createSpec() (*VerySecret, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(very_secret.Table, sqlgraph.NewFieldSpec(very_secret.FieldID, field.TypeUUID))
	)
	...
	if value, ok := vsc.mutation.Password(); ok {
		_spec.SetField(very_secret.FieldPassword, field.TypeString, value)
