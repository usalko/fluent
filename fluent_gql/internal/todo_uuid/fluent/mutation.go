...
func (m *FriendshipMutation) SetUserID(uuid_uuid uuid.UUID) {
	m.user = &uuid_uuid
}
...
func (m *FriendshipMutation) SetFriendID(uuid_uuid uuid.UUID) {
	m.friend = &uuid_uuid
}
...
func (m *TodoMutation) SetCategoryID(uuid_uuid uuid.UUID) {
	m.category = &uuid_uuid
}
