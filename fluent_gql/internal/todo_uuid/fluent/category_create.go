...
func (cc *CategoryCreate) SetID(uuid_uuid uuid.UUID) *CategoryCreate {
	cc.mutation.SetID(uuid_uuid)
	return cc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (cc *CategoryCreate) SetNillableID(uuid_uuid *uuid.UUID) *CategoryCreate {
	if uuid_uuid != nil {
		cc.SetID(*uuid_uuid)
	}
	return cc
