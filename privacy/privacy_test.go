...
func (f policyFunc) Policy() fluent.Policy {
	return f
}

func (f policyFunc) EvalQuery(ctx context.Context, _ fluent.Query) error {
	return f(ctx)
}

func (f policyFunc) EvalMutation(ctx context.Context, _ fluent.Mutation) error {
	return f(ctx)
}
