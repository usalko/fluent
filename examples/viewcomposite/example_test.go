...
import (
	...
	"github.com/usalko/fluent/examples/viewcomposite/fluent"
	"github.com/usalko/fluent/examples/viewcomposite/fluent/petusername"
...
func TestViews(t *testing.T) {
	...
	client, err := fluent.Open(dialect.Postgres, os.Getenv("DB_URL"))
	if err != nil {
		log.Fatalln(err)
	}
