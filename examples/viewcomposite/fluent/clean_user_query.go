...
import (
	...
	"github.com/usalko/fluent/examples/viewcomposite/fluent/clean_user"
...
func (cuq *CleanUserQuery) Order(o ...clean_user.OrderOption) *CleanUserQuery {
...
func (cuq *CleanUserQuery) First(ctx context.Context) (*CleanUser, error) {
	nodes, err := cuq.Limit(1).All(setContextOp(ctx, cuq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{clean_user.Label}
	}
	return nodes[0], nil
}
...
func (cuq *CleanUserQuery) Only(ctx context.Context) (*CleanUser, error) {
	nodes, err := cuq.Limit(2).All(setContextOp(ctx, cuq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{clean_user.Label}
	default:
		return nil, &NotSingularError{clean_user.Label}
	}
}
...
func (cuq *CleanUserQuery) All(ctx context.Context) ([]*CleanUser, error) {
	ctx = setContextOp(ctx, cuq.ctx, fluent.OpQueryAll)
...
func (cuq *CleanUserQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, cuq.ctx, fluent.OpQueryCount)
	if err := cuq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (cuq *CleanUserQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, cuq.ctx, fluent.OpQueryExist)
...
func (cuq *CleanUserQuery) Clone() *CleanUserQuery {
	...
	return &CleanUserQuery{
		config:     cuq.config,
		ctx:        cuq.ctx.Clone(),
		order:      append([]clean_user.OrderOption{}, cuq.order...),
...
func (cuq *CleanUserQuery) GroupBy(field string, fields ...string) *CleanUserGroupBy {
	...
	grbuild.label = clean_user.Label
...
func (cuq *CleanUserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(clean_user.Table, clean_user.Columns, nil)
	_spec.From = cuq.sql
...
func (cuq *CleanUserQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(clean_user.Table)
	columns := cuq.ctx.Fields
	if len(columns) == 0 {
		columns = clean_user.Columns
	}
...
func (cugb *CleanUserGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, cugb.build.ctx, fluent.OpQueryGroupBy)
...
func (cus *CleanUserSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, cus.ctx, fluent.OpQuerySelect)
