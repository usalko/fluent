...
// Value returns the fluent.Value that was dynamically selected and assigned to the PetUserName.
// This includes values selected through modifiers, order, etc.
func (pun *PetUserName) Value(name string) (fluent.Value, error) {
...
func (pun *PetUserName) Unwrap() *PetUserName {
	...
	if !ok {
		panic("fluent: PetUserName is not a transactional entity")
	}
