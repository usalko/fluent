...
// Value returns the fluent.Value that was dynamically selected and assigned to the Payment.
// This includes values selected through modifiers, order, etc.
func (pa *Payment) Value(name string) (fluent.Value, error) {
...
func (pa *Payment) Unwrap() *Payment {
	...
	if !ok {
		panic("fluent: Payment is not a transactional entity")
	}
