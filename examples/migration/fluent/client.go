...
func (c *PaymentClient) mutate(ctx context.Context, m *PaymentMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Payment mutation op: %q", m.Op())
	}
}
...
func (c *SessionDeviceClient) mutate(ctx context.Context, m *SessionDeviceMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown SessionDevice mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Card, Payment, Pet, Session, SessionDevice, User []fluent.Hook
	}
	inters struct {
		Card, Payment, Pet, Session, SessionDevice, User []fluent.Interceptor
	}
)
