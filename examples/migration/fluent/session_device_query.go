...
type SessionDeviceQuery struct {
	config
	ctx          *QueryContext
	order        []session_device.OrderOption
	inters       []Interceptor
...
func (sdq *SessionDeviceQuery) Order(o ...session_device.OrderOption) *SessionDeviceQuery {
...
func (sdq *SessionDeviceQuery) QuerySessions() *SessionQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(session_device.Table, session_device.FieldID, selector),
...
func (sdq *SessionDeviceQuery) First(ctx context.Context) (*SessionDevice, error) {
	nodes, err := sdq.Limit(1).All(setContextOp(ctx, sdq.ctx, fluent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{session_device.Label}
	}
	return nodes[0], nil
}
...
func (sdq *SessionDeviceQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
	if ids, err = sdq.Limit(1).IDs(setContextOp(ctx, sdq.ctx, fluent.OpQueryFirstID)); err != nil {
		return
	}
	if len(ids) == 0 {
...
func (sdq *SessionDeviceQuery) Only(ctx context.Context) (*SessionDevice, error) {
	nodes, err := sdq.Limit(2).All(setContextOp(ctx, sdq.ctx, fluent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
	...
	case 0:
		return nil, &NotFoundError{session_device.Label}
	default:
		return nil, &NotSingularError{session_device.Label}
	}
}
...
func (sdq *SessionDeviceQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
	if ids, err = sdq.Limit(2).IDs(setContextOp(ctx, sdq.ctx, fluent.OpQueryOnlyID)); err != nil {
		return
	}
	switch len(ids) {
	case 1:
	...
	case 0:
		err = &NotFoundError{session_device.Label}
	default:
		err = &NotSingularError{session_device.Label}
	}
	return
}
...
func (sdq *SessionDeviceQuery) All(ctx context.Context) ([]*SessionDevice, error) {
	ctx = setContextOp(ctx, sdq.ctx, fluent.OpQueryAll)
	if err := sdq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (sdq *SessionDeviceQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	ctx = setContextOp(ctx, sdq.ctx, fluent.OpQueryIDs)
	if err = sdq.Select(session_device.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (sdq *SessionDeviceQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, sdq.ctx, fluent.OpQueryCount)
	if err := sdq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (sdq *SessionDeviceQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, sdq.ctx, fluent.OpQueryExist)
...
func (sdq *SessionDeviceQuery) Clone() *SessionDeviceQuery {
	...
	return &SessionDeviceQuery{
		config:       sdq.config,
		ctx:          sdq.ctx.Clone(),
		order:        append([]session_device.OrderOption{}, sdq.order...),
...
//		GroupBy(session_device.FieldIPAddress).
...
func (sdq *SessionDeviceQuery) GroupBy(field string, fields ...string) *SessionDeviceGroupBy {
	...
	grbuild.label = session_device.Label
...
//
//	client.SessionDevice.Query().
//		Select(session_device.FieldIPAddress).
//		Scan(ctx, &v)
func (sdq *SessionDeviceQuery) Select(fields ...string) *SessionDeviceSelect {
	...
	sbuild.label = session_device.Label
...
func (sdq *SessionDeviceQuery) loadSessions(ctx context.Context, query *SessionQuery, nodes []*SessionDevice, init func(*SessionDevice), assign func(*SessionDevice, *Session)) error {
	...
	query.Where(predicate.Session(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(session_device.SessionsColumn), fks...))
	}))
...
func (sdq *SessionDeviceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(session_device.Table, session_device.Columns, sqlgraph.NewFieldSpec(session_device.FieldID, field.TypeUUID))
	_spec.From = sdq.sql
	...
	if fields := sdq.ctx.Fields; len(fields) > 0 {
		...
		for i := range fields {
			if fields[i] != session_device.FieldID {
...
func (sdq *SessionDeviceQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1 := builder.Table(session_device.Table)
	columns := sdq.ctx.Fields
	if len(columns) == 0 {
		columns = session_device.Columns
	}
...
func (sdgb *SessionDeviceGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, sdgb.build.ctx, fluent.OpQueryGroupBy)
...
func (sds *SessionDeviceSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, sds.ctx, fluent.OpQuerySelect)
