...
func (sdd *SessionDeviceDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(session_device.Table, sqlgraph.NewFieldSpec(session_device.FieldID, field.TypeUUID))
...
func (sddo *SessionDeviceDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{session_device.Label}
	default:
		return nil
	}
}
