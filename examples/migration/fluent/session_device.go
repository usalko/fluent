...
func (*SessionDevice) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case session_device.FieldIPAddress, session_device.FieldUserAgent, session_device.FieldLocation:
			values[i] = new(sql.NullString)
		case session_device.FieldCreatedAt, session_device.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case session_device.FieldID:
...
// Value returns the fluent.Value that was dynamically selected and assigned to the SessionDevice.
// This includes values selected through modifiers, order, etc.
func (sd *SessionDevice) Value(name string) (fluent.Value, error) {
...
func (sd *SessionDevice) Unwrap() *SessionDevice {
	...
	if !ok {
		panic("fluent: SessionDevice is not a transactional entity")
	}
