...
type PaymentFunc func(context.Context, *fluent.PaymentMutation) (fluent.Value, error)

// Mutate calls f(ctx, m).
func (f PaymentFunc) Mutate(ctx context.Context, m fluent.Mutation) (fluent.Value, error) {
	if mv, ok := m.(*fluent.PaymentMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *fluent.PaymentMutation", m)
}
...
type SessionDeviceFunc func(context.Context, *fluent.SessionDeviceMutation) (fluent.Value, error)

// Mutate calls f(ctx, m).
func (f SessionDeviceFunc) Mutate(ctx context.Context, m fluent.Mutation) (fluent.Value, error) {
	if mv, ok := m.(*fluent.SessionDeviceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *fluent.SessionDeviceMutation", m)
}
