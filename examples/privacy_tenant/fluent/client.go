...
import (
	...
	"github.com/usalko/fluent/examples/privacy_tenant/fluent/migrate"
...
func (c *TenantClient) mutate(ctx context.Context, m *TenantMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("fluent: unknown Tenant mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		Group, Tenant, User []fluent.Hook
	}
	inters struct {
		Group, Tenant, User []fluent.Interceptor
	}
)
