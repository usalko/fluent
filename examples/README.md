...
![er-traversal-graph](https://github.com/usalko/fluent/images/assets/er_traversal_graph.png)
...
![er-traversal-graph-gopher](https://github.com/usalko/fluent/images/assets/er_traversal_graph_gopher.png)
...
```go
func Traverse(ctx context.Context, client *fluent.Client) error {
...
![er-traversal-graph-gopher-query](https://github.com/usalko/fluent/images/assets/er_traversal_graph_gopher_query.png)
...
![er-user-card](https://github.com/usalko/fluent/images/assets/er_user_card.png)
...
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/o2o2types).

## O2O Same Type

![er-linked-list](https://github.com/usalko/fluent/images/assets/er_linked_list.png)
...
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/o2o2recur).

## O2O Bidirectional

![er-user-spouse](https://github.com/usalko/fluent/images/assets/er_user_spouse.png)
...
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/o2obidi).

## O2M Two Types

![er-user-pets](https://github.com/usalko/fluent/images/assets/er_user_pets.png)
...
```
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/o2m2types).

## O2M Same Type

![er-tree](https://github.com/usalko/fluent/images/assets/er_tree.png)
...
func Do(ctx context.Context, client *fluent.Client) error {
	...
	ints := client.Node.
		...
		Order(fluent.Asc(node.FieldValue)).     // Order by their `value` field.
...
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/o2mrecur).

## M2M Two Types

![er-user-groups](https://github.com/usalko/fluent/images/assets/er_user_groups.png)
...
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/m2m2types).

## M2M Same Type

![er-following-followers](https://github.com/usalko/fluent/images/assets/er_following_followers.png)
...
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/m2mrecur).


## M2M Bidirectional

![er-user-friends](https://github.com/usalko/fluent/images/assets/er_user_friends.png)
...
The full example exists in [GitHub](https://github.com/usalko/fluent/tree/master/examples/m2mbidi).
...
![er-city-streets](https://github.com/usalko/fluent/images/assets/er_city_streets.png)
