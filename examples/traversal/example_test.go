...
import (
	...
	"github.com/usalko/fluent/examples/traversal/fluent"
	"github.com/usalko/fluent/examples/traversal/fluent/group"
	"github.com/usalko/fluent/examples/traversal/fluent/pet"
	"github.com/usalko/fluent/examples/traversal/fluent/user"
...
func Traverse2(ctx context.Context, client *fluent.Client) error {
	pets, err := client.Pet.
		Query().
		Where(
			pet.HasOwnerWith(
