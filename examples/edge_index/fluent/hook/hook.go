...
type CityFunc func(context.Context, *fluent.CityMutation) (fluent.Value, error)

// Mutate calls f(ctx, m).
func (f CityFunc) Mutate(ctx context.Context, m fluent.Mutation) (fluent.Value, error) {
	if mv, ok := m.(*fluent.CityMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *fluent.CityMutation", m)
}

// The StreetFunc type is an adapter to allow the use of ordinary
// function as Street mutator.
type StreetFunc func(context.Context, *fluent.StreetMutation) (fluent.Value, error)

// Mutate calls f(ctx, m).
func (f StreetFunc) Mutate(ctx context.Context, m fluent.Mutation) (fluent.Value, error) {
	if mv, ok := m.(*fluent.StreetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *fluent.StreetMutation", m)
}
