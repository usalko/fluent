...
// Value returns the fluent.Value that was dynamically selected and assigned to the Car.
// This includes values selected through modifiers, order, etc.
func (c *Car) Value(name string) (fluent.Value, error) {
...
func (c *Car) Unwrap() *Car {
	...
	if !ok {
		panic("fluent: Car is not a transactional entity")
	}
