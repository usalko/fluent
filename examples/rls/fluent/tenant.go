...
// Value returns the fluent.Value that was dynamically selected and assigned to the Tenant.
// This includes values selected through modifiers, order, etc.
func (t *Tenant) Value(name string) (fluent.Value, error) {
...
func (t *Tenant) Unwrap() *Tenant {
	...
	if !ok {
		panic("fluent: Tenant is not a transactional entity")
	}
