...
func main() {
	...
	err = flc.Generate("./schema", &gen.Config{
		...
		Templates: []*gen.Template{
			// Custom templates can be provided by flc.Extension (see below),
		...
		Hooks: []gen.Hook{
			// Hooks can be provided by flc.Extension (see below),
...
// Extension is an example implementation of flc.Extension.
...
// NewExtension creates a new flc.Extension.
...
func (e *Extension) Annotations() []flc.Annotation {
...
func (e *Extension) Options() []flc.Option {
	return []flc.Option{
		flc.TemplateFiles("template/stringer.tmpl"),
	}
}

var _ flc.Extension = (*Extension)(nil)
